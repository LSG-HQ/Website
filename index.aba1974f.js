...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "iyXH2": [
        function(require, module1, exports1) {
            ...
            module1.bundle.HMR_BUNDLE_ID = "a9ae35caf2427ece";
            "use strict";
        ...
        function(require, module1, exports1) {
            ...
            (async function() {
                ...
                if (href.includes("main")) {
                    const cityScape3DRendering = new _scriptJs.CityScape3DRendering();
                    await cityScape3DRendering.render();
                } else if (href.includes("new")) {
                    const chatbot = new _chatbotJs.Chatbot();
                    chatbot.init();
                }
            })();
            // hamburger.init();
   ...
   */ if (currentCharIndex == sentence.length && currentHeaderChar == currentHeaderWord.length) {
    ...
    "gu1Gz": [
        function(require, module1, exports1) {
            ...
            parcelHelpers.export(exports1, "Chatbot", ()=>Chatbot);
    ...
    <div class="widget-head">
      <button class="back-btn">
        <img src=${_backSvgDefault.default} />
      </button>
  
      <button class="expand-btn">
        <img src=${_expandSvgDefault.default} />
      </button>
    </div>
  `;
                activities = [
      ...
      <div class="activity">
        <div>
          <img src=${_chatPngDefault.default} alt=${activityLabel} class="chat" />
          <p>${activityLabel ?? ""}</p>
        </div>
  
        <img src=${_ellipsisSvgDefault.default} class="ellipsis" />
      </div>
    `;
                };
...
<img src=${_cleoPngDefault.default} alt="CLEO" class="cleo-image-popup can-show">
<div class="cleo">
  <div id="cleo-stage-0">
    <img src=${_cleoPngDefault.default} alt="CLEO" class="cleo-image">
    ...
    <div class="flex w-full">
      <button type="button" id="get-started-btn">Get started
        <img src=${_arrowHeadSvgDefault.default} />
      </button>
    </div>
  </div>
  ...
  <div id="cleo-stage-2">
    ...
    <div class="menu">
      <div class="menu-left">
        <img src=${_chatPngDefault.default}></img>
        <p>Chat with Cleo</p>
      </div>

      <div class="menu-right">
        <div class="menu-right-up">
          <img src=${_gamePadPngDefault.default}></img>
        </div>
  ...
  <div id="bottom-shade">
    ...
    `;
        ...
        },
        {
            "./../pngs/cleo.png": "iqfhs",
            "./../pngs/chat.png": "5MZFy",
            "./../pngs/gamePad.png": "hT4r4",
            "./../svgs/arrowHead.svg": "7rTG5",
            "./../svgs/back.svg": "6CYwJ",
            "./../svgs/expand.svg": "doT8u",
            "./../svgs/ellipsis.svg": "9D2CH",
            "./utils": "02IhW",
            "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3"
        }
    ],
    "iqfhs": [
        function(require, module1, exports1) {
            module1.exports = require("31dcb287767ca04d").getBundleURL("ezcJq") + "cleo.a70d2aec.png" + "?" + Date.now();
        },
        {
            "31dcb287767ca04d": "lgJ39"
        }
    ],
    "lgJ39": [
        function(require, module1, exports1) {
            ...
            exports1.getBundleURL = getBundleURLCached;
            exports1.getBaseURL = getBaseURL;
            exports1.getOrigin = getOrigin;
        },
        {}
    ],
    "5MZFy": [
        function(require, module1, exports1) {
            module1.exports = require("7af10d1bb46ffc0e").getBundleURL("ezcJq") + "chat.66aa62cd.png" + "?" + Date.now();
        },
        {
            "7af10d1bb46ffc0e": "lgJ39"
        }
    ],
    "hT4r4": [
        function(require, module1, exports1) {
            module1.exports = require("1d183494749fe8ff").getBundleURL("ezcJq") + "gamePad.d14220bb.png" + "?" + Date.now();
        },
        {
            "1d183494749fe8ff": "lgJ39"
        }
    ],
    "7rTG5": [
        function(require, module1, exports1) {
            module1.exports = require("d96645ecae89aa7e").getBundleURL("ezcJq") + "arrowHead.3344572e.svg" + "?" + Date.now();
        },
        {
            "d96645ecae89aa7e": "lgJ39"
        }
    ],
    "6CYwJ": [
        function(require, module1, exports1) {
            module1.exports = require("20bdd2afcd1ab707").getBundleURL("ezcJq") + "back.ac723f3c.svg" + "?" + Date.now();
        },
        {
            "20bdd2afcd1ab707": "lgJ39"
        }
    ],
    "doT8u": [
        function(require, module1, exports1) {
            module1.exports = require("b9fa45d18d9bcd9f").getBundleURL("ezcJq") + "expand.2c037b6a.svg" + "?" + Date.now();
        },
        {
            "b9fa45d18d9bcd9f": "lgJ39"
        }
    ],
    "9D2CH": [
        function(require, module1, exports1) {
            module1.exports = require("ef979da22e2c58e3").getBundleURL("ezcJq") + "ellipsis.ac1df473.svg" + "?" + Date.now();
        },
        {
            "ef979da22e2c58e3": "lgJ39"
        }
    ],
    "02IhW": [
        function(require, module1, exports1) {
            ...
            parcelHelpers.export(exports1, "_", ()=>_);
            parcelHelpers.export(exports1, "__", ()=>__);
            const $ = (id)=>{
                return document.getElementById(id);
            };
            const _ = (selector)=>{
    ...
    "iyXH2",
    "5lBMl"
], "5lBMl", "parcelRequire0561");

//# sourceMappingURL=index.aba1974f.js.map
