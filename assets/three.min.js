...
THREE.Quaternion.prototype = {
  ...
  multiplyQuaternions: function (a, b) {
    var c = a.x,
      ...
      i = b.z,
      j = b.w;
    this.x = c * j + f * h + d * i - e * g;
    this.y = d * j + f * g + e * h - c * i;
    this.z = e * j + f * i + c * g - d * h;
    this.w = f * j - c * h - d * g - e * i;
    return this;
  },
...
THREE.Vector3.prototype = {
  ...
  setEulerFromQuaternion: function (a, b) {
    ...
    var d = a.x * a.x,
      ...
      h = a.w * a.w;
    void 0 === b || "XYZ" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w - a.y * a.z), h - d - e + f)),
        (this.y = Math.asin(c(2 * (a.x * a.z + a.y * a.w)))),
        (this.z = Math.atan2(2 * (a.z * a.w - a.x * a.y), h + d - e - f)))
      : "YXZ" === b
      ? ((this.x = Math.asin(c(2 * (a.x * a.w - a.y * a.z)))),
        (this.y = Math.atan2(2 * (a.x * a.z + a.y * a.w), h - d - e + f)),
        (this.z = Math.atan2(2 * (a.x * a.y + a.z * a.w), h - d + e - f)))
      : "ZXY" === b
      ? ((this.x = Math.asin(c(2 * (a.x * a.w + a.y * a.z)))),
        (this.y = Math.atan2(2 * (a.y * a.w - a.z * a.x), h - d - e + f)),
        (this.z = Math.atan2(2 * (a.z * a.w - a.x * a.y), h - d + e - f)))
      : "ZYX" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w + a.z * a.y), h - d - e + f)),
        (this.y = Math.asin(c(2 * (a.y * a.w - a.x * a.z)))),
        (this.z = Math.atan2(2 * (a.x * a.y + a.z * a.w), h + d - e - f)))
      : "YZX" === b
      ? ((this.x = Math.atan2(2 * (a.x * a.w - a.z * a.y), h - d + e - f)),
        (this.y = Math.atan2(2 * (a.y * a.w - a.x * a.z), h + d - e - f)),
...
THREE.Matrix4 = function (a, b, c, d, e, f, h, g, i, j, l, n, m, q, t, p) {
...
THREE.Matrix4.prototype = {
  ...
  set: function (a, b, c, d, e, f, h, g, i, j, l, n, m, q, t, p) {
    var r = this.elements;
    r[0] = a;
    r[4] = b;
    r[8] = c;
  ...
  multiplyMatrices: function (a, b) {
    ...
    e[5] = j * C + l * A + n * N + m * Z;
    e[9] = j * H + l * K + n * y + m * L;
    e[13] = j * I + l * B + n * M + m * d;
    e[2] = q * G + t * F + p * J + r * w;
    e[6] = q * C + t * A + p * N + r * Z;
    e[10] = q * H + t * K + p * y + r * L;
    e[14] = q * I + t * B + p * M + r * d;
    e[3] = s * G + v * F + z * J + c * w;
    e[7] = s * C + v * A + z * N + c * Z;
    ...
    return (
      ...
      a[11] *
        (+b * i * l -
          ...
          c * i * j) +
      a[15] *
        (-d * h * j - b * g * l + b * h * n + d * f * l - c * f * n + c * g * j)
    );
  },
  transpose: function () {
    var a = this.elements,
  ...
  getInverse: function (a, b) {
    var c = this.elements,
      ...
      d = d[15];
    c[0] =
      l * p * s - n * t * s + n * q * v - j * p * v - l * q * d + j * t * d;
    c[4] =
      g * t * s - h * p * s - g * q * v + f * p * v + h * q * d - f * t * d;
    c[8] =
      h * n * s - g * l * s + g * j * v - f * n * v - h * j * d + f * l * d;
    c[12] =
      g * l * q - h * n * q - g * j * t + f * n * t + h * j * p - f * l * p;
    c[1] =
      n * t * r - l * p * r - n * m * v + i * p * v + l * m * d - i * t * d;
    c[5] =
      h * p * r - g * t * r + g * m * v - e * p * v - h * m * d + e * t * d;
    c[9] =
      g * l * r - h * n * r - g * i * v + e * n * v + h * i * d - e * l * d;
    c[13] =
      h * n * m - g * l * m + g * i * t - e * n * t - h * i * p + e * l * p;
    c[2] =
      j * p * r - n * q * r + n * m * s - i * p * s - j * m * d + i * q * d;
    c[6] =
      g * q * r - f * p * r - g * m * s + e * p * s + f * m * d - e * q * d;
    c[10] =
      f * n * r - g * j * r + g * i * s - e * n * s - f * i * d + e * j * d;
    c[14] =
      g * j * m - f * n * m - g * i * q + e * n * q + f * i * p - e * j * p;
    c[3] =
      l * q * r - j * t * r - l * m * s + i * t * s + j * m * v - i * q * v;
    c[7] =
      f * t * r - h * q * r + h * m * s - e * t * s - f * m * v + e * q * v;
    c[11] =
      h * j * r - f * l * r - h * i * s + e * l * s + f * i * v - e * j * v;
    c[15] =
      f * l * m - h * j * m + h * i * q - e * l * q - f * i * t + e * j * t;
    c = e * c[0] + i * c[4] + m * c[8] + r * c[12];
    if (0 == c) {
      if (b)
        throw Error(
...
THREE.extend(THREE.Matrix4.prototype, {
  decompose: (function () {
    ...
    return function (e, f, h) {
      ...
      h = h instanceof THREE.Vector3 ? h : new THREE.Vector3();
      h.x = a.length();
      h.y = b.length();
      h.z = c.length();
      e.x = g[12];
...
THREE.Frustum.prototype = {
  ...
  setFromMatrix: function (a) {
    var b = this.planes,
      ...
      r = c[14],
      c = c[15];
    b[0].setComponents(f - a, j - h, q - l, c - t).normalize();
    b[1].setComponents(f + a, j + h, q + l, c + t).normalize();
    b[2].setComponents(f + d, j + g, q + n, c + p).normalize();
    b[3].setComponents(f - d, j - g, q - n, c - p).normalize();
    b[4].setComponents(f - e, j - i, q - m, c - r).normalize();
    b[5].setComponents(f + e, j + i, q + m, c + r).normalize();
    return this;
  },
...
THREE.Spline = function (a) {
  ...
  this.getPoint = function (a) {
    ...
    g = h * h;
    i = h * g;
    d.x = b(j.x, l.x, n.x, m.x, h, g, i);
    d.y = b(j.y, l.y, n.y, m.y, h, g, i);
    d.z = b(j.z, l.z, n.z, m.z, h, g, i);
    return d;
  };
  ...
  var b = new a.Sphere(),
    ...
    i = function (g, j, m) {
      if (g instanceof a.Particle) {
        ...
        var q = j.ray.distanceToPoint(f);
        if (q > g.scale.x) return m;
        m.push({ distance: q, point: g.position, face: null, object: g });
      } else if (g instanceof a.LOD)
        f.getPositionFromMatrix(g.matrixWorld),
          (q = j.ray.origin.distanceTo(f)),
          i(g.getObjectForDistance(q), j, m);
        ...
        if (!1 === j.ray.isIntersectionSphere(b)) return m;
        var q = g.geometry,
          t = q.vertices;
        if (q instanceof a.BufferGeometry) {
          var p = g.material;
          if (void 0 === p || !q.dynamic) return m;
          ...
          new a.Vector3();
          new a.Vector3();
          for (var I = 0; I < q.offsets.length; ++I)
            for (
              var F = q.offsets[I].start,
                A = q.offsets[I].index,
                K = F,
                B = F + q.offsets[I].count;
              K < B;
              K += 3
            )
              if (
                (t
                  ? ((v = A + q.attributes.index.array[K]),
                    (z = A + q.attributes.index.array[K + 1]),
                    (G = A + q.attributes.index.array[K + 2]))
                  : ((v = A), (z = A + 1), (G = A + 2)),
                r.set(
                  q.attributes.position.array[3 * v],
                  q.attributes.position.array[3 * v + 1],
                  q.attributes.position.array[3 * v + 2]
                ),
                s.set(
                  q.attributes.position.array[3 * z],
                  q.attributes.position.array[3 * z + 1],
                  q.attributes.position.array[3 * z + 2]
                ),
                H.set(
                  q.attributes.position.array[3 * G],
                  q.attributes.position.array[3 * G + 1],
                  q.attributes.position.array[3 * G + 2]
                ),
                d.setFromCoplanarPoints(r, s, H),
                (F = c.distanceToPlane(d)),
                !(Math.abs(F) < C) && !(0 > F))
              ) {
                v = p.side;
                if (
                  v !== a.DoubleSide &&
                  ((z = c.direction.dot(d.normal)),
                  !(v === a.FrontSide ? 0 > z : 0 < z))
                )
                  continue;
                F < j.near ||
                  F > j.far ||
                  ((e = c.at(F, e)),
                  a.Triangle.containsPoint(e, r, s, H) &&
                    m.push({
                      distance: F,
                      point: j.ray.at(F),
                      face: null,
          ...
          c.copy(j.ray).applyMatrix4(h);
          I = 0;
          for (H = q.faces.length; I < H; I++)
            if (
              ((A = q.faces[I]),
              (p = !0 === r ? s[A.materialIndex] : g.material),
              void 0 !== p &&
                (d.setFromNormalAndCoplanarPoint(A.normal, t[A.a]),
                (F = c.distanceToPlane(d)),
                !(Math.abs(F) < C) && !(0 > F)))
            ) {
              v = p.side;
              ...
              if (!(F < j.near || F > j.far)) {
                ...
                if (A instanceof a.Face3) {
                  if (
                    ...
                    (z = t[A.b]),
                    (G = t[A.c]),
                    !a.Triangle.containsPoint(e, v, z, G))
                  )
                    continue;
                  ...
                  if (
                    ...
                    (G = t[A.c]),
                    (p = t[A.d]),
                    !a.Triangle.containsPoint(e, v, z, p) &&
                      !a.Triangle.containsPoint(e, z, G, p))
                  )
                    continue;
...
THREE.Projector = function () {
  ...
  var d,
    ...
    F = [],
    A = 0,
    K = { objects: [], sprites: [], lights: [], elements: [] },
    B = new THREE.Vector3(),
    J = new THREE.Vector4(),
    N = new THREE.Box3(
  ...
  var V = function (a) {
      ...
      null !== a.renderDepth
        ? (d.z = a.renderDepth)
        : (B.getPositionFromMatrix(a.matrixWorld),
          B.applyProjection(L),
          (d.z = B.z));
      return d;
    },
    ea = function (a) {
      if (!1 !== a.visible) {
        a instanceof THREE.Light
          ...
          ? (!1 === a.frustumCulled || !0 === Fa.intersectsObject(a)) &&
            K.objects.push(V(a))
  ...
  this.projectScene = function (d, f, h, l) {
    ...
    for (h = K.objects.length; d < h; d++)
      if (
        ((ma = K.objects[d].object),
        (oa = ma.matrixWorld),
        (i = 0),
        ma instanceof THREE.Mesh)
      ) {
        xa = ma.geometry;
        da = xa.vertices;
        bb = xa.faces;
        xa = xa.faceVertexUvs;
        Va.getNormalMatrix(oa);
        ha = ma.material instanceof THREE.MeshFaceMaterial;
        ra = !0 === ha ? ma.material : null;
        B = 0;
        for (fa = da.length; B < fa; B++)
          (g = a()),
            g.positionWorld.copy(da[B]).applyMatrix4(oa),
        ...
        da = 0;
        for (B = bb.length; da < B; da++) {
          fa = bb[da];
          var ka = !0 === ha ? ra.materials[fa.materialIndex] : ma.material;
          if (void 0 !== ka) {
            la = ka.side;
            if (fa instanceof THREE.Face3)
              if (
                ...
                (aa = j[fa.b]),
                (Y = j[fa.c]),
                (M[0] = T.positionScreen),
                (M[1] = aa.positionScreen),
                (M[2] = Y.positionScreen),
                !0 === T.visible ||
                  !0 === aa.visible ||
                  !0 === Y.visible ||
                  N.isIntersectionBox(y.setFromPoints(M)))
              )
                if (
                  ((V =
                    0 >
                    (Y.positionScreen.x - T.positionScreen.x) *
                      (aa.positionScreen.y - T.positionScreen.y) -
                      (Y.positionScreen.y - T.positionScreen.y) *
                        (aa.positionScreen.x - T.positionScreen.x)),
                  la === THREE.DoubleSide || V === (la === THREE.FrontSide))
                )
                  m === t
              ...
              if (
                ...
                (Y = j[fa.c]),
                (ia = j[fa.d]),
                (w[0] = T.positionScreen),
                (w[1] = aa.positionScreen),
                (w[2] = Y.positionScreen),
                (w[3] = ia.positionScreen),
                !0 === T.visible ||
                  !0 === aa.visible ||
                  !0 === Y.visible ||
                  !0 === ia.visible ||
                  N.isIntersectionBox(y.setFromPoints(w)))
              )
                if (
                  ((V =
                    0 >
                      (ia.positionScreen.x - T.positionScreen.x) *
                        (aa.positionScreen.y - T.positionScreen.y) -
                        (ia.positionScreen.y - T.positionScreen.y) *
                          (aa.positionScreen.x - T.positionScreen.x) ||
                    0 >
                      (aa.positionScreen.x - Y.positionScreen.x) *
                        (ia.positionScreen.y - Y.positionScreen.y) -
                        (aa.positionScreen.y - Y.positionScreen.y) *
            ...
            n.normalModel.copy(fa.normal);
            !1 === V &&
              (la === THREE.BackSide || la === THREE.DoubleSide) &&
              n.normalModel.negate();
            n.normalModel.applyMatrix3(Va).normalize();
            n.normalModelView.copy(n.normalModel).applyMatrix3(O);
            n.centroidModel.copy(fa.centroid).applyMatrix4(oa);
            Y = fa.vertexNormals;
            T = 0;
            for (aa = Y.length; T < aa; T++)
              (ia = n.vertexNormalsModel[T]),
                ia.copy(Y[T]),
                !1 === V &&
                  (la === THREE.BackSide || la === THREE.DoubleSide) &&
                  ia.negate(),
                ia.applyMatrix3(Va).normalize(),
                n.vertexNormalsModelView[T].copy(ia).applyMatrix3(O);
            n.vertexNormalsLength = Y.length;
            T = 0;
            for (aa = xa.length; T < aa; T++)
              if (((ia = xa[T][da]), void 0 !== ia)) {
                la = 0;
                for (Y = ia.length; la < Y; la++) n.uvs[T][la] = ia[la];
              }
            n.color = fa.color;
            n.material = ka;
            qa.copy(n.centroidModel).applyProjection(L);
            n.z = qa.z;
            K.elements.push(n);
          }
        }
      } else if (ma instanceof THREE.Line) {
        Pa.multiplyMatrices(L, oa);
        da = ma.geometry.vertices;
        T = a();
        T.positionScreen.copy(da[0]).applyMatrix4(Pa);
        bb = ma.type === THREE.LinePieces ? 2 : 1;
        B = 1;
        for (fa = da.length; B < fa; B++)
          (T = a()),
            T.positionScreen.copy(da[B]).applyMatrix4(Pa),
            0 < (B + 1) % bb ||
              ((aa = j[i - 2]),
              wa.copy(T.positionScreen),
              D.copy(aa.positionScreen),
              !0 === c(wa, D) &&
                (wa.multiplyScalar(1 / wa.w),
                D.multiplyScalar(1 / D.w),
                z === C
                  ? ((xa = new THREE.RenderableLine()),
                    G.push(xa),
                    C++,
                    z++,
                    (v = xa))
                  : (v = G[z++]),
                v.v1.positionScreen.copy(wa),
                v.v2.positionScreen.copy(D),
                (v.z = Math.max(wa.z, D.z)),
                (v.material = ma.material),
                ma.material.vertexColors === THREE.VertexColors &&
                  (v.vertexColors[0].copy(ma.geometry.colors[B]),
                  v.vertexColors[1].copy(ma.geometry.colors[B - 1])),
                K.elements.push(v)));
      }
    d = 0;
    for (h = K.sprites.length; d < h; d++)
      (ma = K.sprites[d].object),
        (oa = ma.matrixWorld),
        ma instanceof THREE.Particle &&
          (J.set(oa.elements[12], oa.elements[13], oa.elements[14], 1),
          J.applyMatrix4(L),
          (J.z /= J.w),
          0 < J.z &&
            1 > J.z &&
            (I === A
              ? ((V = new THREE.RenderableParticle()),
                F.push(V),
                A++,
                I++,
                (H = V))
            ...
            (H.y = J.y / J.w),
            (H.z = J.z),
            (H.rotation = ma.rotation.z),
            (H.scale.x =
              ma.scale.x *
              Math.abs(
                H.x -
                  (J.x + f.projectionMatrix.elements[0]) /
                    (J.w + f.projectionMatrix.elements[12])
              )),
            (H.scale.y =
              ma.scale.y *
              Math.abs(
                H.y -
                  (J.y + f.projectionMatrix.elements[5]) /
                    (J.w + f.projectionMatrix.elements[13])
              )),
            (H.material = ma.material),
            K.elements.push(H)));
...
THREE.Geometry.prototype = {
  ...
  computeTangents: function () {
    function a(a, b, c, d, e, f, y) {
      ...
      H = m.y - l.y;
      I = 1 / (z * H - G * C);
      B.set((H * q - C * t) * I, (H * p - C * r) * I, (H * s - C * v) * I);
      J.set((z * t - G * q) * I, (z * r - G * p) * I, (z * v - G * s) * I);
      A[b].add(B);
      A[c].add(B);
      A[d].add(B);
      K[b].add(J);
    ...
    for (c = this.vertices.length; b < c; b++)
      (A[b] = new THREE.Vector3()), (K[b] = new THREE.Vector3());
    b = 0;
    for (c = this.faces.length; b < c; b++)
      (f = this.faces[b]),
    ...
    for (c = this.faces.length; b < c; b++) {
      ...
      for (d = 0; d < f.vertexNormals.length; d++)
        M.copy(f.vertexNormals[d]),
          (e = f[w[d]]),
          (F = A[e]),
          N.copy(F),
          N.sub(M.multiplyScalar(M.dot(F))).normalize(),
          y.crossVectors(f.vertexNormals[d], F),
          (e = y.dot(K[e])),
          (e = 0 > e ? -1 : 1),
          (f.vertexTangents[d] = new THREE.Vector4(N.x, N.y, N.z, e));
    }
    this.hasTangents = !0;
  },
  ...
  mergeVertices: function () {
    ...
    for (h = this.faces.length; f < h; f++)
      if (((a = this.faces[f]), a instanceof THREE.Face3)) {
        ...
        if (0 <= d) {
          ...
          g = 0;
          for (i = this.faceVertexUvs.length; g < i; g++)
            (j = this.faceVertexUvs[g][f]) && j.splice(d, 1);
          a.vertexNormals &&
    ...
    for (f = e.length - 1; 0 <= f; f--) {
      ...
      g = 0;
      for (i = this.faceVertexUvs.length; g < i; g++)
        this.faceVertexUvs[g].splice(f, 1);
    }
...
THREE.BufferGeometry.prototype = {
  ...
  computeBoundingSphere: function () {
    ...
    var a = this.attributes.position.array;
    if (a) {
      for (var b, c = 0, d, e, f = 0, h = a.length; f < h; f += 3)
        (b = a[f]),
          (d = a[f + 1]),
          (e = a[f + 2]),
          (b = b * b + d * d + e * e),
  ...
  computeTangents: function () {
    function a(a) {
      ...
      qa = g[a];
      L.copy(qa);
      L.sub(Pa.multiplyScalar(Pa.dot(qa))).normalize();
      oa.crossVectors(Va, qa);
      Fa = oa.dot(i[a]);
      O = 0 > Fa ? -1 : 1;
      h[4 * a] = L.x;
      h[4 * a + 1] = L.y;
    ...
    if (
      ...
      for (
        var h = this.attributes.tangent.array, g = [], i = [], j = 0;
        j < f;
        j++
      )
        (g[j] = new THREE.Vector3()), (i[j] = new THREE.Vector3());
      var l,
        n,
        m,
        q,
  ...
  createMaterial: function (a, b) {
      ...
      if (!s) {
        ...
        a.onload = function () {
          if (!c(this.width) || !c(this.height)) {
            ...
            G.image.width = a;
            G.image.height = b;
            G.image.getContext("2d").drawImage(this, 0, 0, a, b);
          } else G.image = this;
          G.needsUpdate = !0;
        };
    ...
    a.mapNormal
      ? ((g = THREE.ShaderLib.normalmap),
        (j = THREE.UniformsUtils.clone(g.uniforms)),
...
THREE.JSONLoader.prototype.parse = function (a, b) {
  ...
  for (i = z.length; g < i; ) {
    ...
    if (e)
      for (e = 0; e < H; e++)
        (r = a.uvs[e]),
          ...
          (v = r[2 * m]),
          (m = r[2 * m + 1]),
          (c.faceUvs[e][h] = new THREE.Vector2(v, m));
    if (f)
      for (e = 0; e < H; e++) {
        r = a.uvs[e];
        s = [];
    ...
    t && ((l = z[g++]), (l = new THREE.Color(C[l])), (p.color = l));
    if (q)
      for (e = 0; e < j; e++)
        (l = z[g++]), (l = new THREE.Color(C[l])), p.vertexColors.push(l);
    c.faces.push(p);
  }
  if (a.skinWeights) {
    g = 0;
    for (i = a.skinWeights.length; g < i; g += 2)
      (z = a.skinWeights[g]),
        (G = a.skinWeights[g + 1]),
        c.skinWeights.push(new THREE.Vector4(z, G, 0, 0));
  }
  if (a.skinIndices) {
    g = 0;
    for (i = a.skinIndices.length; g < i; g += 2)
      (z = a.skinIndices[g]),
        (G = a.skinIndices[g + 1]),
        c.skinIndices.push(new THREE.Vector4(z, G, 0, 0));
  }
  c.bones = a.bones;
  ...
  if (void 0 !== a.morphTargets) {
    ...
    for (i = a.morphTargets.length; g < i; g++) {
      ...
      C = c.morphTargets[g].vertices;
      H = a.morphTargets[g].vertices;
      z = 0;
      for (G = H.length; z < G; z += 3)
        (q = new THREE.Vector3()),
          (q.x = H[z] * d),
          (q.y = H[z + 1] * d),
          (q.z = H[z + 2] * d),
  ...
  if (void 0 !== a.morphColors) {
    ...
    for (i = a.morphColors.length; g < i; g++) {
      ...
      d = 0;
      for (z = C.length; d < z; d += 3)
        (H = new THREE.Color(16755200)),
          H.setRGB(C[d], C[d + 1], C[d + 2]),
          G.push(H);
    }
  }
  c.computeCentroids();
  ...
  parseObject: function (a, b, c) {
    ...
    switch (a.type) {
      ...
      case "PerspectiveCamera":
        d = new THREE.PerspectiveCamera(a.fov, a.aspect, a.near, a.far);
        d.position.fromArray(a.position);
        d.rotation.fromArray(a.rotation);
        break;
      case "OrthographicCamera":
        ...
        break;
      case "AmbientLight":
        d = new THREE.AmbientLight(a.color);
        break;
      case "DirectionalLight":
        d = new THREE.DirectionalLight(a.color, a.intensity);
        d.position.fromArray(a.position);
        break;
      case "PointLight":
        d = new THREE.PointLight(a.color, a.intensity, a.distance);
        d.position.fromArray(a.position);
        break;
      case "SpotLight":
        d = new THREE.SpotLight(
          a.color,
          a.intensity,
          a.distance,
          a.angle,
      ...
      case "HemisphereLight":
        d = new THREE.HemisphereLight(a.color, a.groundColor, a.intensity);
        d.position.fromArray(a.position);
        break;
      case "Mesh":
        d = new THREE.Mesh(b[a.geometry], c[a.material]);
        d.position.fromArray(a.position);
        d.rotation.fromArray(a.rotation);
        d.scale.fromArray(a.scale);
        break;
      default:
  ...
  parse: function (a, b, c) {
    ...
    function f(a, b) {
      ...
      for (m in b) {
        var r = A.objects[m],
          s = b[m];
        if (void 0 === r) {
          if (s.type && s.type in n.hierarchyHandlers) {
            if (void 0 === s.loading) {
              e = {
                type: 1,
                url: 1,
              ...
              s.loading = !0;
              e = n.hierarchyHandlers[s.type].loaderObject;
              e.options
                ? e.load(d(s.url, B.urlBaseType), g(m, a, t, s))
                : e.load(d(s.url, B.urlBaseType), g(m, a, t, s), h);
            }
            ...
            if ((q = A.geometries[s.geometry])) {
              ...
              l = s.quaternion;
              s.material ||
                (t = new THREE.MeshFaceMaterial(A.face_materials[s.geometry]));
              ...
              r && q.computeTangents();
              s.skin
                ? (r = new THREE.SkinnedMesh(q, t))
                : s.morph
                ? ((r = new THREE.MorphAnimMesh(q, t)),
                  void 0 !== s.duration && (r.duration = s.duration),
                  void 0 !== s.time && (r.time = s.time),
                  void 0 !== s.mirroredLoop &&
                    (r.mirroredLoop = s.mirroredLoop),
                  t.morphNormals && q.computeMorphNormals())
                : (r = new THREE.Mesh(q, t));
              r.name = m;
              c
                ...
                : (r.position.fromArray(h),
                  l
                    ? (r.quaternion.fromArray(l), (r.useQuaternion = !0))
                    : r.rotation.fromArray(i),
                  r.scale.fromArray(j));
              r.visible = s.visible;
            ...
            "PointLight" === s.type ||
            "AmbientLight" === s.type
              ? ((z = void 0 !== s.color ? s.color : 16777215),
                (G = void 0 !== s.intensity ? s.intensity : 1),
                "DirectionalLight" === s.type
                  ? ((h = s.direction),
                    (v = new THREE.DirectionalLight(z, G)),
                    v.position.fromArray(h),
                    s.target &&
                      (K.push({ object: v, targetName: s.target }),
                      (v.target = null)))
                  : "PointLight" === s.type
                  ? ((h = s.position),
                    (e = s.distance),
                    (v = new THREE.PointLight(z, G, e)),
                    v.position.fromArray(h))
                  : "AmbientLight" === s.type &&
                    (v = new THREE.AmbientLight(z)),
                a.add(v),
                (v.name = m),
                (A.lights[m] = v),
                (A.objects[m] = v))
              ...
              ? ((h = s.position),
                ...
                "PerspectiveCamera" === s.type
                  ...
                  : "OrthographicCamera" === s.type &&
                    (p = new THREE.OrthographicCamera(
                      s.left,
                      s.right,
                      s.top,
                      s.bottom,
                ...
                (p.name = m),
                p.position.fromArray(h),
                void 0 !== l
                  ? (p.quaternion.fromArray(l), (p.useQuaternion = !0))
                  : void 0 !== i && p.rotation.fromArray(i),
                a.add(p),
                (A.cameras[m] = p),
                (A.objects[m] = p))
              : ((h = s.position),
                ...
                l
                  ...
                  : r.rotation.fromArray(i),
                r.scale.fromArray(j),
                (r.visible = void 0 !== s.visible ? s.visible : !1),
                a.add(r),
                (A.objects[m] = r),
                (A.empties[m] = r));
          if (r) {
            if (void 0 !== s.userData)
              for (var C in s.userData) r.userData[C] = s.userData[C];
            if (void 0 !== s.groups)
    ...
    function g(a, b, c, d) {
      return function (f) {
        ...
        g
          ? (f.quaternion.fromArray(g), (f.useQuaternion = !0))
          : f.rotation.fromArray(h);
        f.scale.fromArray(i);
        c &&
    ...
    function l(a, b) {
      b(a);
      if (void 0 !== a.children) for (var c in a.children) l(a.children[c], b);
    }
    var n = this,
      ...
      B = a,
      J;
    for (J in this.geometryHandlers)
      (a = this.geometryHandlers[J].loaderClass),
        (this.geometryHandlers[J].loaderObject = new a());
    for (J in this.hierarchyHandlers)
      (a = this.hierarchyHandlers[J].loaderClass),
        (this.hierarchyHandlers[J].loaderObject = new a());
    H = C = 0;
    A = {
    ...
    if (
      ...
      (c = B.transform.scale),
      J && A.scene.position.fromArray(J),
    ...
    for (var N in B.fogs)
      (a = B.fogs[N]),
        ...
        (A.fogs[N] = r);
    for (var y in B.geometries)
      (r = B.geometries[y]),
        r.type in this.geometryHandlers && ((C += 1), n.onLoadStart());
    for (var M in B.objects)
      l(B.objects[M], function (a) {
        a.type && a.type in n.hierarchyHandlers && ((C += 1), n.onLoadStart());
      });
    I = C;
    for (y in B.geometries)
      if (((r = B.geometries[y]), "cube" === r.type))
        (q = new THREE.CubeGeometry(
          r.width,
          r.height,
          r.depth,
          r.widthSegments,
        ...
        (q = new THREE.IcosahedronGeometry(r.radius, r.subdivisions)),
          (q.name = y),
          (A.geometries[y] = q);
        ...
        "embedded" === r.type &&
          ...
          M &&
            ((M = this.geometryHandlers.ascii.loaderObject.parse(M, "")),
            i(y)(M.geometry, M.materials)));
    for (var w in B.textures)
      if (((y = B.textures[w]), y.url instanceof Array)) {
        H += y.url.length;
        for (s = 0; s < y.url.length; s++) n.onLoadStart();
      } else (H += 1), n.onLoadStart();
    F = H;
    for (w in B.textures) {
      y = B.textures[w];
      void 0 !== y.mapping &&
      ...
      if (y.url instanceof Array) {
        ...
        s = (s = /\.dds$/i.test(r[0]))
          ? THREE.ImageUtils.loadCompressedTextureCube(r, y.mapping, J(M))
          : THREE.ImageUtils.loadTextureCube(r, y.mapping, J(M));
      } else
        (s = /\.dds$/i.test(y.url)),
          (M = d(y.url, B.urlBaseType)),
          (r = J(1)),
          (s = s
            ? THREE.ImageUtils.loadCompressedTexture(M, y.mapping, r)
            : THREE.ImageUtils.loadTexture(M, y.mapping, r)),
          ...
          y.repeat &&
            (s.repeat.set(y.repeat[0], y.repeat[1]),
          ...
          y.wrap &&
            ...
            void 0 !== M[y.wrap[0]] && (s.wrapS = M[y.wrap[0]]),
            void 0 !== M[y.wrap[1]] && (s.wrapT = M[y.wrap[1]]));
      A.textures[w] = s;
    }
    var Z, L;
    for (Z in B.materials) {
      w = B.materials[Z];
      for (L in w.parameters)
        "envMap" === L || "map" === L || "lightMap" === L || "bumpMap" === L
          ? (w.parameters[L] = A.textures[w.parameters[L]])
          : "shading" === L
          ? (w.parameters[L] =
              "flat" === w.parameters[L]
                ? THREE.FlatShading
          ...
          : "blending" === L
          ? (w.parameters[L] =
              w.parameters[L] in THREE
                ? THREE[w.parameters[L]]
          ...
          : "vertexColors" === L
          ? "face" == w.parameters[L]
            ? (w.parameters[L] = THREE.FaceColors)
            : w.parameters[L] && (w.parameters[L] = THREE.VertexColors)
          : "wrapRGB" === L &&
            ((J = w.parameters[L]),
            (w.parameters[L] = new THREE.Vector3(J[0], J[1], J[2])));
      void 0 !== w.parameters.opacity &&
        1 > w.parameters.opacity &&
        (w.parameters.transparent = !0);
      w.parameters.normalMap
        ? ((J = THREE.ShaderLib.normalmap),
          (y = THREE.UniformsUtils.clone(J.uniforms)),
          (s = w.parameters.color),
          (M = w.parameters.specular),
          (r = w.parameters.ambient),
          (N = w.parameters.shininess),
          (y.tNormal.value = A.textures[w.parameters.normalMap]),
          w.parameters.normalScale &&
            y.uNormalScale.value.set(
              w.parameters.normalScale[0],
              w.parameters.normalScale[1]
            ),
          w.parameters.map &&
            ((y.tDiffuse.value = w.parameters.map),
            (y.enableDiffuse.value = !0)),
          w.parameters.envMap &&
            ((y.tCube.value = w.parameters.envMap),
            (y.enableReflection.value = !0),
            (y.uReflectivity.value = w.parameters.reflectivity)),
          w.parameters.lightMap &&
            ((y.tAO.value = w.parameters.lightMap), (y.enableAO.value = !0)),
          w.parameters.specularMap &&
            ((y.tSpecular.value = A.textures[w.parameters.specularMap]),
            (y.enableSpecular.value = !0)),
          w.parameters.displacementMap &&
            ((y.tDisplacement.value = A.textures[w.parameters.displacementMap]),
            (y.enableDisplacement.value = !0),
            (y.uDisplacementBias.value = w.parameters.displacementBias),
            (y.uDisplacementScale.value = w.parameters.displacementScale)),
          y.uDiffuseColor.value.setHex(s),
          y.uSpecularColor.value.setHex(M),
          y.uAmbientColor.value.setHex(r),
          (y.uShininess.value = N),
          w.parameters.opacity && (y.uOpacity.value = w.parameters.opacity),
    ...
    for (Z in B.materials)
      if (((w = B.materials[Z]), w.parameters.materials)) {
        L = [];
        for (s = 0; s < w.parameters.materials.length; s++)
          L.push(A.materials[w.parameters.materials[s]]);
        A.materials[Z].materials = L;
      }
    e();
    A.cameras &&
      B.defaults.camera &&
      (A.currentCamera = A.cameras[B.defaults.camera]);
    A.fogs && B.defaults.fog && (A.scene.fog = A.fogs[B.defaults.fog]);
    n.callbackSync(A);
    j();
  }
};
...
THREE.CanvasRenderer = function (a) {
  function b(a, b, c) {
    for (var d = 0, e = I.length; d < e; d++) {
      ...
      if (f instanceof THREE.DirectionalLight) {
        var h = Xa.getPositionFromMatrix(f.matrixWorld).normalize(),
          g = b.dot(h);
        0 >= g || ((g *= f.intensity), c.add(Xb.multiplyScalar(g)));
      } else
        f instanceof THREE.PointLight &&
          ((h = Xa.getPositionFromMatrix(f.matrixWorld)),
          (g = b.dot(Xa.subVectors(h, a).normalize())),
          0 >= g ||
            ((g *=
              0 == f.distance
                ? 1
  ...
  function c(a, c, e, l, q, r, U, p) {
    ...
    null === p.map
      ? (Qa.copy(p.color),
        Ya.copy(p.emissive),
        p.vertexColors === THREE.FaceColors && Qa.multiply(U.color),
        !1 === p.wireframe &&
        p.shading == THREE.SmoothShading &&
        3 == U.vertexNormalsLength
          ? (ra.copy(ib),
            ka.copy(ib),
            ua.copy(ib),
            b(U.v1.positionWorld, U.vertexNormalsModel[0], ra),
            b(U.v2.positionWorld, U.vertexNormalsModel[1], ka),
            b(U.v3.positionWorld, U.vertexNormalsModel[2], ua),
            ra.multiply(Qa).add(Ya),
            ka.multiply(Qa).add(Ya),
            ua.multiply(Qa).add(Ya),
            Ra.addColors(ka, ua).multiplyScalar(0.5),
            (lb = j(ra, ka, ua, Ra)),
            i(ya, Ha, fa, da, T, aa, 0, 0, 1, 0, 0, 1, lb))
          : (ha.copy(ib),
            b(U.centroidModel, U.normalModel, ha),
            ha.multiply(Qa).add(Ya),
            !0 === p.wireframe
              ? f(
                  ha,
      ...
      : p instanceof THREE.MeshBasicMaterial ||
        ...
        p instanceof THREE.MeshPhongMaterial
      ? null !== p.map
        ? p.map.mapping instanceof THREE.UVMapping &&
          ((Ga = U.uvs[0]),
          g(
            ya,
            Ha,
        ...
        : null !== p.envMap
        ? p.envMap.mapping instanceof THREE.SphericalReflectionMapping &&
          (Xa.copy(U.vertexNormalsModelView[l]),
          (Ca = 0.5 * Xa.x + 0.5),
          (yb = 0.5 * Xa.y + 0.5),
          Xa.copy(U.vertexNormalsModelView[q]),
          (Ib = 0.5 * Xa.x + 0.5),
          (k = 0.5 * Xa.y + 0.5),
          Xa.copy(U.vertexNormalsModelView[r]),
          (Rb = 0.5 * Xa.x + 0.5),
          (Yb = 0.5 * Xa.y + 0.5),
          g(ya, Ha, fa, da, T, aa, Ca, yb, Ib, k, Rb, Yb, p.envMap))
        : (ha.copy(p.color),
          p.vertexColors === THREE.FaceColors && ha.multiply(U.color),
          !0 === p.wireframe
            ? f(
                ha,
                p.wireframeLinewidth,
      ...
      ? ((Sa = D.near),
        (xb = D.far),
        (ra.r = ra.g = ra.b =
          1 - z(a.positionScreen.z * a.positionScreen.w, Sa, xb)),
        (ka.r = ka.g = ka.b =
          1 - z(c.positionScreen.z * c.positionScreen.w, Sa, xb)),
        (ua.r = ua.g = ua.b =
          1 - z(e.positionScreen.z * e.positionScreen.w, Sa, xb)),
        Ra.addColors(ka, ua).multiplyScalar(0.5),
        (lb = j(ra, ka, ua, Ra)),
        i(ya, Ha, fa, da, T, aa, 0, 0, 1, 0, 0, 1, lb))
      : p instanceof THREE.MeshNormalMaterial &&
        (p.shading == THREE.FlatShading
          ? ((a = U.normalModelView),
            ha.setRGB(a.x, a.y, a.z).multiplyScalar(0.5).addScalar(0.5),
            !0 === p.wireframe
              ? f(
                  ha,
                  p.wireframeLinewidth,
              ...
              : h(ha))
          : p.shading == THREE.SmoothShading &&
            ((a = U.vertexNormalsModelView[l]),
            ra.setRGB(a.x, a.y, a.z).multiplyScalar(0.5).addScalar(0.5),
            (a = U.vertexNormalsModelView[q]),
            ka.setRGB(a.x, a.y, a.z).multiplyScalar(0.5).addScalar(0.5),
            (a = U.vertexNormalsModelView[r]),
            ua.setRGB(a.x, a.y, a.z).multiplyScalar(0.5).addScalar(0.5),
            Ra.addColors(ka, ua).multiplyScalar(0.5),
            (lb = j(ra, ka, ua, Ra)),
            i(ya, Ha, fa, da, T, aa, 0, 0, 1, 0, 0, 1, lb)));
  }
  ...
  function g(a, b, c, d, e, f, g, k, i, j, n, l, m) {
    if (
      !(
      ...
      if (!0 === m.needsUpdate) {
        var p = m.wrapS == THREE.RepeatWrapping,
          q = m.wrapT == THREE.RepeatWrapping;
        Jb[m.id] = y.createPattern(
          m.image,
          !0 === p && !0 === q
            ? "repeat"
            : !0 === p && !1 === q
      ...
      void 0 === Jb[m.id] ? s("rgba(0,0,0,1)") : s(Jb[m.id]);
      var p = m.offset.x / m.repeat.x,
        q = m.offset.y / m.repeat.y,
      ...
      0 === p
        ? (void 0 === Ab[m.id] &&
          ...
          (b = Ab[m.id]),
          (g = 4 * (Math.floor(g) + Math.floor(k) * m.image.width)),
          ha.setRGB(b[g] / 255, b[g + 1] / 255, b[g + 2] / 255),
          h(ha))
        : ((p = 1 / p),
          (m = (l * c - j * e) * p),
          (j = (l * d - j * f) * p),
          ...
          (g = b - j * g - d * k),
          y.save(),
          y.transform(m, j, c, d, a, g),
          y.fill(),
          y.restore());
    }
  }
  function i(a, b, c, d, e, f, h, g, k, i, j, n, l) {
    var m, p;
    m = l.width - 1;
    p = l.height - 1;
    h *= m;
  ...
  function q(a) {
    Va !== a && (Va = y.lineWidth = a);
  }
  function t(a) {
    O !== a && (O = y.lineCap = a);
  }
  function p(a) {
    qa !== a && (qa = y.lineJoin = a);
  }
  function r(a) {
    oa !== a && (oa = y.strokeStyle = a);
  }
  function s(a) {
  ...
  this.setSize = function (a, b, c) {
    ...
    na.set(new THREE.Vector2(-J, -N), new THREE.Vector2(J, N));
    Z = 1;
    L = 0;
    qa = O = Va = Pa = oa = null;
  };
  ...
  this.render = function (a, g) {
    if (!1 === g instanceof THREE.Camera)
      console.error(
      ...
      C = F.projectScene(a, g, this.sortObjects, this.sortElements);
      H = C.elements;
      I = C.lights;
      D = g;
      ib.setRGB(0, 0, 0);
      ...
      for (var k = 0, A = I.length; k < A; k++) {
        var w = I[k],
          B = w.color;
        w instanceof THREE.AmbientLight
          ? ib.add(B)
          : w instanceof THREE.DirectionalLight
          ? Tb.add(B)
          : w instanceof THREE.PointLight && Ub.add(B);
      }
      k = 0;
        ...
        if (!(void 0 === w || !1 === w.visible)) {
          ...
          if (U instanceof THREE.RenderableParticle) {
            ...
            var mb = void 0,
              ...
              Jc = void 0,
              Kc = void 0;
            w instanceof THREE.ParticleBasicMaterial
              ? null === w.map
                ? ((vb = U.object.scale.x),
                  (zb = U.object.scale.y),
                  (vb *= U.scale.x * J),
                  (zb *= U.scale.y * N),
                  va.min.set(B.x - vb, B.y - zb),
                  va.max.set(B.x + vb, B.y + zb),
                  !1 === fb.isIntersectionBox(va)
                    ? va.makeEmpty()
                    : (s(w.color.getStyle()),
                      y.save(),
                      y.translate(B.x, B.y),
                ...
                : ((Zb = w.map.image),
                  ...
                  (mb = vb * Jc),
                  (nb = zb * Kc),
                  va.min.set(B.x - mb, B.y - nb),
                  va.max.set(B.x + mb, B.y + nb),
                  !1 === fb.isIntersectionBox(va)
                    ? va.makeEmpty()
                    : (y.save(),
                      y.translate(B.x, B.y),
                      ...
                      y.drawImage(Zb, 0, 0),
                      y.restore()))
              : w instanceof THREE.ParticleCanvasMaterial &&
                ((mb = U.scale.x * J),
                (nb = U.scale.y * N),
                va.min.set(B.x - mb, B.y - nb),
                va.max.set(B.x + mb, B.y + nb),
            ...
            if (
              ...
              va.setFromPoints([V.positionScreen, ea.positionScreen]),
              !0 === fb.isIntersectionBox(va))
            )
              if (
                ((B = V),
                (mb = ea),
                ...
                m(w.blending),
                y.beginPath(),
                y.moveTo(B.positionScreen.x, B.positionScreen.y),
                y.lineTo(mb.positionScreen.x, mb.positionScreen.y),
                w instanceof THREE.LineBasicMaterial)
              ) {
                q(w.linewidth);
                t(w.linecap);
                p(w.linejoin);
                if (w.vertexColors !== THREE.VertexColors)
                  r(w.color.getStyle());
                else if (
                  ((nb = U.vertexColors[0].getStyle()),
                  (U = U.vertexColors[1].getStyle()),
                  nb === U)
                )
                  r(nb);
                else {
                  try {
                    var wc = y.createLinearGradient(
                      B.positionScreen.x,
                      B.positionScreen.y,
                      mb.positionScreen.x,
                      mb.positionScreen.y
                ...
                w instanceof THREE.LineDashedMaterial &&
                  (q(w.linewidth),
                  t(w.linecap),
                  p(w.linejoin),
                  r(w.color.getStyle()),
                  v(w.dashSize, w.gapSize),
                  y.stroke(),
                  va.expandByScalar(2 * w.linewidth),
                  v(null, null));
            ...
            ea.positionScreen.x *= J;
            ea.positionScreen.y *= N;
            pa.positionScreen.x *= J;
            pa.positionScreen.y *= N;
            0 < w.overdraw &&
              (l(V.positionScreen, ea.positionScreen, w.overdraw),
              l(ea.positionScreen, pa.positionScreen, w.overdraw),
              l(pa.positionScreen, V.positionScreen, w.overdraw));
            va.setFromPoints([
              V.positionScreen,
              ea.positionScreen,
              pa.positionScreen
            ]);
            !0 === fb.isIntersectionBox(va) && c(V, ea, pa, 0, 1, 2, U, w);
            ...
            if (-1 > ea.positionScreen.z || 1 < ea.positionScreen.z) continue;
            if (-1 > pa.positionScreen.z || 1 < pa.positionScreen.z) continue;
            if (-1 > Ua.positionScreen.z || 1 < Ua.positionScreen.z) continue;
            V.positionScreen.x *= J;
            V.positionScreen.y *= N;
            ea.positionScreen.x *= J;
            ea.positionScreen.y *= N;
            pa.positionScreen.x *= J;
            pa.positionScreen.y *= N;
            Ua.positionScreen.x *= J;
            Ua.positionScreen.y *= N;
            pb.positionScreen.copy(ea.positionScreen);
            ub.positionScreen.copy(Ua.positionScreen);
            0 < w.overdraw &&
              (l(V.positionScreen, ea.positionScreen, w.overdraw),
              l(ea.positionScreen, Ua.positionScreen, w.overdraw),
              l(Ua.positionScreen, V.positionScreen, w.overdraw),
              l(pa.positionScreen, pb.positionScreen, w.overdraw),
              l(pa.positionScreen, ub.positionScreen, w.overdraw));
            va.setFromPoints([
              V.positionScreen,
              ea.positionScreen,
              pa.positionScreen,
            ...
            !0 === fb.isIntersectionBox(va) &&
              ...
              n(w.opacity),
              m(w.blending),
              (void 0 !== w.map && null !== w.map) ||
              (void 0 !== w.envMap && null !== w.envMap)
                ? (c(B, mb, vb, 0, 1, 3, U, w), c(zb, nb, Zb, 1, 2, 3, U, w))
                : ((ya = B.positionScreen.x),
                  (Ha = B.positionScreen.y),
                  (fa = mb.positionScreen.x),
                  (da = mb.positionScreen.y),
                  (T = nb.positionScreen.x),
                  (aa = nb.positionScreen.y),
                  (la = vb.positionScreen.x),
                  (Y = vb.positionScreen.y),
                  (ma = zb.positionScreen.x),
                  (xa = zb.positionScreen.y),
                  (bb = Zb.positionScreen.x),
                  (ia = Zb.positionScreen.y),
                  ...
                  w instanceof THREE.MeshPhongMaterial
                    ? (Qa.copy(w.color),
                      ...
                      4 == U.vertexNormalsLength
                        ? (ra.copy(ib),
                          ...
                          b(U.v1.positionWorld, U.vertexNormalsModel[0], ra),
                          b(U.v2.positionWorld, U.vertexNormalsModel[1], ka),
                          b(U.v4.positionWorld, U.vertexNormalsModel[3], ua),
                          b(U.v3.positionWorld, U.vertexNormalsModel[2], Ra),
                          ra.multiply(Qa).add(Ya),
                          ka.multiply(Qa).add(Ya),
                          ua.multiply(Qa).add(Ya),
                          Ra.multiply(Qa).add(Ya),
                          (lb = j(ra, ka, ua, Ra)),
                          d(ya, Ha, fa, da, la, Y),
                          i(ya, Ha, fa, da, la, Y, 0, 0, 1, 0, 0, 1, lb),
                          d(ma, xa, T, aa, bb, ia),
                          i(ma, xa, T, aa, bb, ia, 1, 0, 1, 1, 0, 1, lb))
                        : (ha.copy(ib),
                          b(U.centroidModel, U.normalModel, ha),
                          ha.multiply(Qa).add(Ya),
                          e(ya, Ha, fa, da, T, aa, la, Y),
                          !0 === w.wireframe
                            ? f(
                                ha,
                      ...
                      w.shading == THREE.FlatShading
                        ? ((B = U.normalModelView),
                          ...
                          !0 === w.wireframe
                            ...
                            : h(ha))
                        : w.shading == THREE.SmoothShading &&
                          ((B = U.vertexNormalsModelView[0]),
                          ra
                            .setRGB(B.x, B.y, B.z)
                            .multiplyScalar(0.5)
                            .addScalar(0.5),
                          (B = U.vertexNormalsModelView[1]),
                          ka
                            .setRGB(B.x, B.y, B.z)
                            .multiplyScalar(0.5)
                            .addScalar(0.5),
                          (B = U.vertexNormalsModelView[3]),
                          ua
                            .setRGB(B.x, B.y, B.z)
                            .multiplyScalar(0.5)
                            .addScalar(0.5),
                          (B = U.vertexNormalsModelView[2]),
                          Ra.setRGB(B.x, B.y, B.z)
                            .multiplyScalar(0.5)
                            .addScalar(0.5),
                          (lb = j(ra, ka, ua, Ra)),
                          d(ya, Ha, fa, da, la, Y),
                    ...
                    : w instanceof THREE.MeshDepthMaterial &&
                      ...
                      (xb = D.far),
                      (ra.r = ra.g = ra.b =
                        1 - z(B.positionScreen.z * B.positionScreen.w, Sa, xb)),
                      (ka.r = ka.g = ka.b =
                        1 -
                        z(mb.positionScreen.z * mb.positionScreen.w, Sa, xb)),
                      (ua.r = ua.g = ua.b =
                        1 -
                        z(vb.positionScreen.z * vb.positionScreen.w, Sa, xb)),
                      (Ra.r = Ra.g = Ra.b =
                        1 -
                        z(nb.positionScreen.z * nb.positionScreen.w, Sa, xb)),
                      (lb = j(ra, ka, ua, Ra)),
                      d(ya, Ha, fa, da, la, Y),
                      i(ya, Ha, fa, da, la, Y, 0, 0, 1, 0, 0, 1, lb),
                      d(ma, xa, T, aa, bb, ia),
...
THREE.WebGLRenderer = function (a) {
  ...
  function n(a, b, c) {
    if (a.length)
      for (var d = 0, e = a.length; d < e; d++)
        (ya = pa = null),
          (pb = ub = T = da = bb = xa = aa = -1),
          (yb = !0),
          a[d].render(b, c, Xb, Jb),
          (ya = pa = null),
          (pb = ub = T = da = bb = xa = aa = -1),
          (yb = !0);
  }
  function m(a, b, c, d, e, f, h, g) {
    var k, i, j, n;
    ...
    for (var l = i; l !== b; l += n)
      if (((k = a[l]), k.render)) {
        ...
        if (g) k = g;
          ...
          if (!k) continue;
          h &&
            D.setBlending(k.blending, k.blendEquation, k.blendSrc, k.blendDst);
        ...
        j instanceof THREE.BufferGeometry
          ? D.renderBufferDirect(d, e, f, k, j, i)
          : D.renderBuffer(d, e, f, k, j, i);
      }
  }
  function q(a, b, c, d, e, f, h) {
    for (var g, k, i = 0, j = a.length; i < j; i++)
      if (((g = a[i]), (k = g.object), k.visible)) {
        if (h) g = h;
          ...
          if (!g) continue;
          f &&
            D.setBlending(g.blending, g.blendEquation, g.blendSrc, g.blendDst);
  ...
  function t(a, b) {
    ...
    if (
      ...
      void 0 !== a.geometry &&
        ...
        a.geometry.addEventListener("dispose", lc)),
      (f = a.geometry),
      void 0 !== f)
    )
      if (f instanceof THREE.BufferGeometry) {
        ...
        for (i in f.attributes)
          (j = "index" === i ? k.ELEMENT_ARRAY_BUFFER : k.ARRAY_BUFFER),
            ...
            (g.buffer = k.createBuffer()),
            k.bindBuffer(j, g.buffer),
            k.bufferData(j, g.array, k.STATIC_DRAW);
        ...
        if (void 0 === f.geometryGroups) {
          ...
          i.geometryGroups = {};
          h = 0;
          for (n = i.faces.length; h < n; h++)
            (l = i.faces[h]),
              (m = v ? l.materialIndex : 0),
              void 0 === j[m] && (j[m] = { hash: m, counter: 0 }),
              (r = j[m].hash + "_" + j[m].counter),
              ...
              (q = l instanceof THREE.Face3 ? 3 : 4),
              ...
              l instanceof THREE.Face3
                ? i.geometryGroups[r].faces3.push(h)
                : i.geometryGroups[r].faces4.push(h),
              (i.geometryGroups[r].vertices += q);
          i.geometryGroupsList = [];
          for (g in i.geometryGroups)
            (i.geometryGroups[g].id = Ha++),
        ...
        a instanceof THREE.Ribbon
          ? f.__webglVertexBuffer ||
            ((g = f),
            (g.__webglVertexBuffer = k.createBuffer()),
            (g.__webglColorBuffer = k.createBuffer()),
            (g.__webglNormalBuffer = k.createBuffer()),
            D.info.memory.geometries++,
            (g = f),
            (i = g.vertices.length),
            (g.__vertexArray = new Float32Array(3 * i)),
            (g.__colorArray = new Float32Array(3 * i)),
            (g.__normalArray = new Float32Array(3 * i)),
            (g.__webglVertexCount = i),
            c(g, a),
            (f.verticesNeedUpdate = !0),
            (f.colorsNeedUpdate = !0),
            (f.normalsNeedUpdate = !0))
          ...
          ? f.__webglVertexBuffer ||
            ...
            (g.__webglVertexBuffer = k.createBuffer()),
            (g.__webglColorBuffer = k.createBuffer()),
            (g.__webglLineDistanceBuffer = k.createBuffer()),
            D.info.memory.geometries++,
            (g = f),
            (i = g.vertices.length),
            (g.__vertexArray = new Float32Array(3 * i)),
      ...
      if (a instanceof THREE.Mesh)
        if (((f = a.geometry), f instanceof THREE.BufferGeometry))
          ...
          if (f instanceof THREE.Geometry)
            for (e in f.geometryGroups)
              (g = f.geometryGroups[e]), p(b.__webglObjects, g, a);
        }
      else
        a instanceof THREE.Ribbon ||
        a instanceof THREE.Line ||
        a instanceof THREE.ParticleSystem
          ? ((f = a.geometry), p(b.__webglObjects, f, a))
  ...
  function v(a, b) {
    ...
    a instanceof THREE.Ribbon ||
    a instanceof THREE.Line
      ? z(b.__webglObjects, a)
      : a instanceof THREE.Sprite
      ? G(b.__webglSprites, a)
      : a instanceof THREE.LensFlare
      ? G(b.__webglFlares, a)
      : (a instanceof THREE.ImmediateRenderObject ||
          a.immediateRenderCallback) &&
        z(b.__webglObjectsImmediate, a);
  ...
  function C(a, b, c, d, e) {
    fa = 0;
    d.needsUpdate &&
      (d.program && vc(d), D.initMaterial(d, b, c, e), (d.needsUpdate = !1));
    d.morphTargets &&
    ...
    var f = !1,
      ...
      g = h.uniforms,
      i = d.uniforms;
    h !== pa && (k.useProgram(h), (pa = h), (f = !0));
    d.id !== pb && ((pb = d.id), (f = !0));
    if (f || a !== ya)
      k.uniformMatrix4fv(g.projectionMatrix, !1, a.projectionMatrix.elements),
        a !== ya && (ya = a);
    if (d.skinning)
      if (Bb && e.useVertexTexture) {
        if (null !== g.boneTexture) {
          var j = H();
          k.uniform1i(g.boneTexture, j);
          D.setTexture(e.boneTexture, j);
        }
      } else
        null !== g.boneGlobalMatrices &&
          k.uniformMatrix4fv(g.boneGlobalMatrices, !1, e.boneMatrices);
    if (f) {
      c &&
        d.fog &&
      ...
      if (
        ...
        if (yb) {
            ...
            (n = b[c]),
              n.onlyShadow ||
                ...
                n instanceof THREE.AmbientLight
                  ? n.visible &&
                    (D.gammaInput
                      ? ((j += p.r * p.r), (l += p.g * p.g), (m += p.b * p.b))
                      : ((j += p.r), (l += p.g), (m += p.b)))
                  : n instanceof THREE.DirectionalLight
                  ? ((da += 1),
                    n.visible &&
                      (Ca.getPositionFromMatrix(n.matrixWorld),
                      Ga.getPositionFromMatrix(n.target.matrixWorld),
                      Ca.sub(Ga),
                      Ca.normalize(),
                      (0 === Ca.x && 0 === Ca.y && 0 === Ca.z) ||
                        ((n = 3 * O),
                        (v[n] = Ca.x),
                        (v[n + 1] = Ca.y),
                        (v[n + 2] = Ca.z),
                        D.gammaInput ? I(t, n, p, q * q) : F(t, n, p, q),
                        (O += 1))))
                  : n instanceof THREE.PointLight
                  ? ((R += 1),
                    n.visible &&
                      ((ba = 3 * ea),
                      D.gammaInput ? I(z, ba, p, q * q) : F(z, ba, p, q),
                      Ga.getPositionFromMatrix(n.matrixWorld),
                      (y[ba] = Ga.x),
                      (y[ba + 1] = Ga.y),
                      (y[ba + 2] = Ga.z),
                      (A[ea] = r),
                  ...
                  ? ((S += 1),
                    n.visible &&
                      ((ba = 3 * T),
                      D.gammaInput ? I(B, ba, p, q * q) : F(B, ba, p, q),
                      Ga.getPositionFromMatrix(n.matrixWorld),
                      (G[ba] = Ga.x),
                      (G[ba + 1] = Ga.y),
                      (G[ba + 2] = Ga.z),
          ...
          c = 3 * T;
          for (f = Math.max(B.length, 3 * S); c < f; c++) B[c] = 0;
          c = 3 * aa;
      ...
      if (
        ...
        d.map
          ...
          : d.normalMap
          ? (Y = d.normalMap)
          : d.bumpMap && (Y = d.bumpMap);
        void 0 !== Y &&
          ((c = Y.offset),
          (Y = Y.repeat),
          i.offsetRepeat.value.set(c.x, c.y, Y.x, Y.y));
      ...
      if (e.receiveShadow && !d._shadowPass && i.shadowMatrix) {
        ...
        for (f = b.length; c < f; c++)
          if (
            ...
            (i.shadowMap.value[Y] = j.shadowMap),
              (i.shadowMapSize.value[Y] = j.shadowMapSize),
              (i.shadowMatrix.value[Y] = j.shadowMatrix),
              (i.shadowDarkness.value[Y] = j.shadowDarkness),
              (i.shadowBias.value[Y] = j.shadowBias),
              Y++;
      }
      b = d.uniformsList;
      i = 0;
      for (Y = b.length; i < Y; i++)
        if ((f = h.uniforms[b[i][1]]))
          if (((c = b[i][0]), (l = c.type), (j = c.value), "i" === l))
              ...
              if (s.image instanceof Array && 6 === s.image.length) {
                if (((c = s), (f = j), 6 === c.image.length))
                  if (c.needsUpdate) {
                      ...
                      D.autoScaleCubemaps && !f
                        ? ((m = j),
                          ...
                          (t.width <= z && t.height <= z) ||
                            ...
                            (v = Math.floor((t.width * z) / y)),
                            (z = Math.floor((t.height * z) / y)),
                    ...
                    s = w(c.format);
                    t = w(c.type);
                    N(k.TEXTURE_CUBE_MAP, c, m);
                    for (l = 0; 6 > l; l++)
                      if (f) {
                        z = j[l].mipmaps;
                        y = 0;
                        for (A = z.length; y < A; y++)
                          (v = z[y]),
            ...
            for (m = c.value.length; l < m; l++)
              (s = c.value[l]), (j = c._array[l]), s && D.setTexture(s, j);
          }
      if (
        ...
        Ga.getPositionFromMatrix(a.matrixWorld),
          k.uniform3f(g.cameraPosition, Ga.x, Ga.y, Ga.z);
      (d instanceof THREE.MeshPhongMaterial ||
        d instanceof THREE.MeshLambertMaterial ||
        d instanceof THREE.ShaderMaterial ||
        d.skinning) &&
        null !== g.viewMatrix &&
        k.uniformMatrix4fv(g.viewMatrix, !1, a.matrixWorldInverse.elements);
    }
    k.uniformMatrix4fv(g.modelViewMatrix, !1, e._modelViewMatrix.elements);
    g.normalMatrix &&
      k.uniformMatrix3fv(g.normalMatrix, !1, e._normalMatrix.elements);
    null !== g.modelMatrix &&
      k.uniformMatrix4fv(g.modelMatrix, !1, e.matrixWorld.elements);
    return h;
  }
  function H() {
    var a = fa;
  ...
  function A(a) {
    a !== ka && (k.lineWidth(a), (ka = a));
  }
  function K(a, b, c) {
    ia !== a &&
      (a ? k.enable(k.POLYGON_OFFSET_FILL) : k.disable(k.POLYGON_OFFSET_FILL),
      (ia = a));
    if (a && (ha !== b || ra !== c)) k.polygonOffset(b, c), (ha = b), (ra = c);
  }
  function B(a) {
  ...
  function J(a, b) {
    ...
    return !k.getShaderParameter(c, k.COMPILE_STATUS)
      ? (console.error(k.getShaderInfoLog(c)), console.error(B(b)), null)
      : c;
  }
  function N(a, b, c) {
    c
      ? (k.texParameteri(a, k.TEXTURE_WRAP_S, w(b.wrapS)),
        k.texParameteri(a, k.TEXTURE_WRAP_T, w(b.wrapT)),
        k.texParameteri(a, k.TEXTURE_MAG_FILTER, w(b.magFilter)),
        k.texParameteri(a, k.TEXTURE_MIN_FILTER, w(b.minFilter)))
      : (k.texParameteri(a, k.TEXTURE_WRAP_S, k.CLAMP_TO_EDGE),
        k.texParameteri(a, k.TEXTURE_WRAP_T, k.CLAMP_TO_EDGE),
        k.texParameteri(a, k.TEXTURE_MAG_FILTER, M(b.magFilter)),
        k.texParameteri(a, k.TEXTURE_MIN_FILTER, M(b.minFilter)));
    if (
      fb &&
      ...
      k.texParameterf(
        a,
        fb.TEXTURE_MAX_ANISOTROPY_EXT,
        Math.min(b.anisotropy, Xa)
      ),
  ...
  function w(a) {
    ...
    if (void 0 !== na) {
      if (a === THREE.RGB_S3TC_DXT1_Format)
        return na.COMPRESSED_RGB_S3TC_DXT1_EXT;
      if (a === THREE.RGBA_S3TC_DXT1_Format)
        return na.COMPRESSED_RGBA_S3TC_DXT1_EXT;
      if (a === THREE.RGBA_S3TC_DXT3_Format)
        return na.COMPRESSED_RGBA_S3TC_DXT3_EXT;
      if (a === THREE.RGBA_S3TC_DXT5_Format)
        return na.COMPRESSED_RGBA_S3TC_DXT5_EXT;
    }
    return 0;
  }
  ...
  var a = a || {},
    ...
    oa = void 0 !== a.alpha ? a.alpha : !0,
    Pa = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0,
    Va = void 0 !== a.antialias ? a.antialias : !1,
  ...
  try {
    if (
      !(k = Z.getContext("experimental-webgl", {
        alpha: oa,
  ...
  Rb = k.getExtension("OES_texture_float");
  ...
  var Ub = k.getParameter(k.MAX_CUBE_MAP_TEXTURE_SIZE),
    Xa = fb ? k.getParameter(fb.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0,
    Gb = 0 < Tb,
    Bb = Gb && Rb;
  na && k.getParameter(k.COMPRESSED_TEXTURE_FORMATS);
  var Kb = k.getShaderPrecisionFormat(k.VERTEX_SHADER, k.HIGH_FLOAT),
  ...
  this.setSize = function (a, b, c) {
    ...
    1 !== this.devicePixelRatio &&
      !1 !== c &&
      ((Z.style.width = a + "px"), (Z.style.height = b + "px"));
  ...
  this.setViewport = function (a, b, c, d) {
    ...
    Ya = void 0 !== d ? d : Z.height;
    k.viewport(ua, Ra, Qa, Ya);
  };
              ...
              for (j in a)
                "index" !== j &&
                  ...
                  0 <= l &&
                    ...
                    g(l),
                    k.vertexAttribPointer(l, n, k.FLOAT, !1, 0, 4 * p * n)));
            ...
            for (j in a)
              "index" !== j &&
                ...
                0 <= l &&
                  (k.bindBuffer(k.ARRAY_BUFFER, h.buffer),
                  g(l),
                  k.vertexAttribPointer(l, n, k.FLOAT, !1, 0, 0)));
    ...
    if (!1 !== d.visible) {
      ...
      if (!d.morphTargets && 0 <= a.position)
        ...
        if (f.morphTargetForcedOrder.length) {
          ...
          for (
            ...
            n < d.numSupportedMorphTargets && n < j.length;

          )
            0 <= c["morphTarget" + n] &&
              (k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[j[n]]),
              g(c["morphTarget" + n]),
              ...
              (f.__webglMorphTargetInfluences[n] = h[j[n]]),
              n++;
        } else {
          j = [];
          h = f.morphTargetInfluences;
          var m,
            p = h.length;
          for (m = 0; m < p; m++) (n = h[m]), 0 < n && j.push([n, m]);
          j.length > d.numSupportedMorphTargets
            ? (j.sort(l), (j.length = d.numSupportedMorphTargets))
          ...
          for (n = 0; n < d.numSupportedMorphTargets; )
            j[n]
              ? ((m = j[n][1]),
                ...
                (f.__webglMorphTargetInfluences[n] = h[m]))
      ...
      f instanceof THREE.Mesh
        ? (d.wireframe
          ...
          D.info.render.calls++,
          (D.info.render.vertices += e.__webglFaceCount),
          (D.info.render.faces += e.__webglFaceCount / 3))
        ...
        ? (k.drawArrays(k.POINTS, 0, e.__webglParticleCount),
          D.info.render.calls++,
          (D.info.render.points += e.__webglParticleCount))
    ...
    if (!1 === b instanceof THREE.Camera)
      ...
      for (e = g.length; d < e; d++)
        if (
          ...
          p._normalMatrix.getNormalMatrix(p._modelViewMatrix);
          var p = f,
            r = p.buffer,
            s = void 0,
            t = (s = void 0),
          ...
          if (t instanceof THREE.MeshFaceMaterial)
            (s = r.materialIndex),
              (s = t.materials[s]),
              s.transparent
                ? ((p.transparent = s), (p.opaque = null))
                : ((p.opaque = s), (p.transparent = null));
          else if ((s = t))
            s.transparent
              ? ((p.transparent = s), (p.opaque = null))
              : ((p.opaque = s), (p.transparent = null));
          ...
          !0 === this.sortObjects &&
            (null !== h.renderDepth
              ? (f.z = h.renderDepth)
              : (Ga.getPositionFromMatrix(h.matrixWorld),
                Ga.applyProjection(xb),
                (f.z = Ga.z)));
        }
      ...
      a.overrideMaterial
        ? ((d = a.overrideMaterial),
          ...
          m(a.__webglObjects, !1, "", b, i, l, !0, d),
          q(a.__webglObjectsImmediate, "", b, i, l, !1, d))
        : ((d = null),
          this.setBlending(THREE.NoBlending),
          m(a.__webglObjects, !0, "opaque", b, i, l, !1, d),
          q(a.__webglObjectsImmediate, "opaque", b, i, l, !1, d),
          m(a.__webglObjects, !1, "transparent", b, i, l, !0, d),
          q(a.__webglObjectsImmediate, "transparent", b, i, l, !0, d));
  ...
  this.renderImmediateObject = function (a, b, c, d, e) {
    ...
    e.immediateRenderCallback
      ? e.immediateRenderCallback(f, k, Sa)
      : e.render(function (a) {
      ...
      if (j instanceof THREE.BufferGeometry) {
        ...
        for (y in z)
          (A = z[y]),
            A.needsUpdate &&
              ("index" === y
                ? (k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, A.buffer),
                  k.bufferData(k.ELEMENT_ARRAY_BUFFER, A.array, q))
                : (k.bindBuffer(k.ARRAY_BUFFER, A.buffer),
                  k.bufferData(k.ARRAY_BUFFER, A.array, q)),
              (A.needsUpdate = !1)),
            w && !A.dynamic && (A.array = null);
      } else if (i instanceof THREE.Mesh) {
        for (var B = 0, G = j.geometryGroupsList.length; B < G; B++)
          if (
            ((n = j.geometryGroupsList[B]),
            (p = e(i, n)),
            j.buffersNeedUpdate && d(n, i),
            (m = p.attributes && r(p)),
            ...
            if (C.__inittedArrays) {
              ...
              if (qb.verticesNeedUpdate) {
                ...
                k.bufferData(k.ARRAY_BUFFER, db, H);
              }
              if (Yb) {
                cb = 0;
                for (bb = ac.length; cb < bb; cb++) {
                  E = ga = 0;
                  for (D = sa.length; E < D; E++)
                    (Va = sa[E]),
                      (Q = kb[Va]),
                      (R = ac[cb].vertices[Q.a]),
                      (S = ac[cb].vertices[Q.b]),
                      (P = ac[cb].vertices[Q.c]),
                      ($a = yb[cb]),
                      ($a[ga] = R.x),
                      ($a[ga + 1] = R.y),
                      ($a[ga + 2] = R.z),
                      ...
                      J.morphNormals &&
                        (M
                          ? ((Qa = Ib[cb].vertexNormals[Va]),
                            (Ha = Qa.a),
                            (ha = Qa.b),
                            (Ua = Qa.c))
                          : (Ua = ha = Ha = Ib[cb].faceNormals[Va]),
                        (ab = Ab[cb]),
                        (ab[ga] = Ha.x),
                        (ab[ga + 1] = Ha.y),
                        (ab[ga + 2] = Ha.z),
                      ...
                      J.morphNormals &&
                        (M
                          ? ((Qa = Ib[cb].vertexNormals[Va]),
                            ...
                            (Ua = Qa.c),
                            (qa = Qa.d))
                          : (qa = Ua = ha = Ha = Ib[cb].faceNormals[Va]),
                        (ab = Ab[cb]),
                        (ab[ga] = Ha.x),
                        (ab[ga + 1] = Ha.y),
                        (ab[ga + 2] = Ha.z),
                  ...
                  k.bufferData(k.ARRAY_BUFFER, yb[cb], H);
                  J.morphNormals &&
                    (k.bindBuffer(
                      k.ARRAY_BUFFER,
                      C.__webglMorphNormalsBuffers[cb]
                    ),
                    k.bufferData(k.ARRAY_BUFFER, Ab[cb], H));
                }
              }
              if ($b.length) {
                E = 0;
                ...
                0 < X &&
                  ...
                  k.bufferData(k.ARRAY_BUFFER, Ma, H),
                  k.bindBuffer(k.ARRAY_BUFFER, C.__webglSkinWeightsBuffer),
                  k.bufferData(k.ARRAY_BUFFER, Na, H));
              }
              if (Xb && K) {
                E = 0;
                for (D = sa.length; E < D; E++)
                  (Q = kb[sa[E]]),
                    (T = Q.vertexColors),
                    (Y = Q.color),
                    3 === T.length && K === THREE.VertexColors
                      ? ((la = T[0]), (ia = T[1]), (ka = T[2]))
                      : (ka = ia = la = Y),
                    (eb[Wa] = la.r),
                    (eb[Wa + 1] = la.g),
                    (eb[Wa + 2] = la.b),
                ...
                for (D = ta.length; E < D; E++)
                  (Q = kb[ta[E]]),
                    (T = Q.vertexColors),
                    (Y = Q.color),
                    4 === T.length && K === THREE.VertexColors
                      ? ((la = T[0]), (ia = T[1]), (ka = T[2]), (ua = T[3]))
                      : (ua = ka = ia = la = Y),
                    (eb[Wa] = la.r),
                    (eb[Wa + 1] = la.g),
                    (eb[Wa + 2] = la.b),
                ...
                0 < Wa &&
                  ...
                  k.bufferData(k.ARRAY_BUFFER, eb, H));
              }
              ...
              if (Hb && Jb && L) {
                ...
                0 < Xa &&
                  ...
                  k.bufferData(k.ARRAY_BUFFER, fb, H));
              }
              if (Hb && Lb && L) {
                E = 0;
                for (D = sa.length; E < D; E++)
                  if (((N = sa[E]), (aa = Lb[N]), void 0 !== aa))
                    for (za = 0; 3 > za; za++)
                      (Ra = aa[za]),
                        (ib[Ya] = Ra.x),
                        (ib[Ya + 1] = Ra.y),
                ...
                0 < Ya &&
                  ...
                  k.bufferData(k.ARRAY_BUFFER, ib, H));
              }
              if (Gb) {
                E = 0;
                for (D = sa.length; E < D; E++)
                  ...
                  if (((u = Bb[za]), u.__original.needsUpdate)) {
                    ...
                    if (1 === u.size)
                      if (void 0 === u.boundTo || "vertices" === u.boundTo) {
                        ...
                        for (D = sa.length; E < D; E++)
                          (Q = kb[sa[E]]),
                            (u.array[x] = u.value[Q.a]),
                            (u.array[x + 1] = u.value[Q.b]),
                            (u.array[x + 2] = u.value[Q.c]),
                            (x += 3);
                        E = 0;
                        for (D = ta.length; E < D; E++)
                          (Q = kb[ta[E]]),
          ...
          if (Mc) {
            ...
            for (Uc = Mc.length; Hc < Uc; Hc++)
              if (
                ...
                ic = Ja.value.length;
                if (1 === Ja.size)
                  for (hb = 0; hb < ic; hb++) Ja.array[hb] = Ja.value[hb];
                else if (2 === Ja.size)
                  for (hb = 0; hb < ic; hb++)
                    (sb = Ja.value[hb]),
                      (Ja.array[Oa] = sb.x),
        ...
        if (
              ...
              for (jc = Wb.length; Eb < jc; Eb++)
                if (
                  ...
                  if (((Fb = $.value.length), (ca = 0), 1 === $.size))
                    for (ja = 0; ja < Fb; ja++) $.array[ja] = $.value[ja];
                  else if (2 === $.size)
                    for (ja = 0; ja < Fb; ja++)
                      (Ea = $.value[ja]),
                        ($.array[ca] = Ea.x),
          ...
          if (Wc || tc.sortParticles)
            k.bindBuffer(k.ARRAY_BUFFER, Nb.__webglVertexBuffer),
              k.bufferData(k.ARRAY_BUFFER, ec, Nc);
          if (Xc || tc.sortParticles)
            k.bindBuffer(k.ARRAY_BUFFER, Nb.__webglColorBuffer),
              k.bufferData(k.ARRAY_BUFFER, fc, Nc);
          if (Wb) {
            Eb = 0;
            for (jc = Wb.length; Eb < jc; Eb++)
              if ((($ = Wb[Eb]), $.needsUpdate || tc.sortParticles))
                k.bindBuffer(k.ARRAY_BUFFER, $.buffer),
                  k.bufferData(k.ARRAY_BUFFER, $.array, Nc);
          }
        }
        j.verticesNeedUpdate = !1;
        j.colorsNeedUpdate = !1;
  ...
  this.initMaterial = function (a, b, c, d) {
    ...
    a: {
      ...
      v = [];
      for (w in s)
        (d = s[w]), !1 !== d && ((d = "#define " + w + " " + d), v.push(d));
      d = v.join("\n");
      w = k.createProgram();
      v = [
        "precision " + L + " float;",
        d,
        Gb ? "#define VERTEX_TEXTURES" : "",
        D.gammaInput ? "#define GAMMA_INPUT" : "",
        D.gammaOutput ? "#define GAMMA_OUTPUT" : "",
        D.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "",
      ...
      k.attachShader(w, t);
      k.linkProgram(w);
      k.getProgramParameter(w, k.LINK_STATUS) ||
        console.error(
          "Could not initialise shader\nVALIDATE_STATUS: " +
            k.getProgramParameter(w, k.VALIDATE_STATUS) +
            ", gl error [" +
            k.getError() +
            "]"
        );
      ...
      z = t;
      t = 0;
      for (v = z.length; t < v; t++)
        (p = z[t]), (w.uniforms[p] = k.getUniformLocation(w, p));
      t = "position normal uv uv2 tangent color skinIndex skinWeight lineDistance".split(
        " "
      );
      for (z = 0; z < c.maxMorphTargets; z++) t.push("morphTarget" + z);
      for (z = 0; z < c.maxMorphNormals; z++) t.push("morphNormal" + z);
      for (j in b) t.push(j);
      j = t;
      z = 0;
      for (b = j.length; z < b; z++)
        (t = j[z]), (w.attributes[t] = k.getAttribLocation(w, t));
      w.id = ea++;
      V.push({ program: w, code: m, usedTimes: 1 });
    ...
    if (a.morphTargets) {
      ...
      for (j = 0; j < this.maxMorphTargets; j++)
        (w = b + j), 0 <= z[w] && a.numSupportedMorphTargets++;
    }
    if (a.morphNormals) {
      a.numSupportedMorphNormals = 0;
      b = "morphNormal";
      for (j = 0; j < this.maxMorphNormals; j++)
        (w = b + j), 0 <= z[w] && a.numSupportedMorphNormals++;
    }
    a.uniformsList = [];
  ...
  this.setMaterialFaces = function (a) {
    ...
    da !== b && (b ? k.disable(k.CULL_FACE) : k.enable(k.CULL_FACE), (da = b));
    T !== a && (a ? k.frontFace(k.CW) : k.frontFace(k.CCW), (T = a));
  };
  this.setDepthTest = function (a) {
    xa !== a &&
      (a ? k.enable(k.DEPTH_TEST) : k.disable(k.DEPTH_TEST), (xa = a));
  };
  this.setDepthWrite = function (a) {
    bb !== a && (k.depthMask(a), (bb = a));
  };
  this.setBlending = function (a, b, c, d) {
    ...
    if (a === THREE.CustomBlending) {
      if ((b !== la && (k.blendEquation(w(b)), (la = b)), c !== Y || d !== ma))
        k.blendFunc(w(c), w(d)), (Y = c), (ma = d);
    } else ma = Y = la = null;
  };
  this.setTexture = function (a, b) {
    if (a.needsUpdate) {
      ...
      if (a instanceof THREE.DataTexture)
        ...
        g = 0;
        for (i = h.length; g < i; g++)
          (c = h[g]), k.texImage2D(k.TEXTURE_2D, g, e, e, f, c);
        a.generateMipmaps = !1;
  ...
  this.setRenderTarget = function (a) {
    ...
    a
      ? ((b = b
        ...
        (a = a.height),
        (e = d = 0))
      : ((b = null), (c = Qa), (a = Ya), (d = ua), (e = Ra));
    b !== Ua &&
      (k.bindFramebuffer(k.FRAMEBUFFER, b), k.viewport(d, e, c, a), (Ua = b));
    Xb = c;
    Jb = a;
  };
...
THREE.GeometryUtils = {
  merge: function (a, b, c) {
    ...
    for (n = l.length; b < n; b++) {
      ...
      m instanceof THREE.Face3
        ? (q = new THREE.Face3(m.a + f, m.b + f, m.c + f))
        : m instanceof THREE.Face4 &&
          (q = new THREE.Face4(m.a + f, m.b + f, m.c + f, m.d + f));
      q.normal.copy(m.normal);
      ...
      q.color.copy(m.color);
      g = 0;
      for (i = r.length; g < i; g++) (t = r[g]), q.vertexColors.push(t.clone());
      q.materialIndex = m.materialIndex + c;
      q.centroid.copy(m.centroid);
      d && q.centroid.applyMatrix4(d);
      j.push(q);
    }
    b = 0;
    for (n = h.length; b < n; b++) {
      c = h[b];
      d = [];
      g = 0;
  ...
  removeMaterials: function (a, b) {
    ...
    for (var f, h = [], d = 0, e = a.faces.length; d < e; d++)
      (f = a.faces[d]), f.materialIndex in c || h.push(f);
    a.faces = h;
  },
  ...
  randomPointInFace: function (a, b, c) {
    ...
    if (a instanceof THREE.Face4) {
      ...
      c
        ...
        : ((c = THREE.GeometryUtils.triangleArea(d, e, b)),
          (h = THREE.GeometryUtils.triangleArea(e, f, b)));
      return THREE.GeometryUtils.random() * (c + h) < c
  ...
  randomPointsInGeometry: function (a, b) {
    ...
    d = [];
    for (e = 0; e < b; e++)
      (h = THREE.GeometryUtils.random() * i),
        (h = c(h)),
    ...
    for (c = a.faces.length; b < c; b++)
      if (((d = a.faces[b]), d instanceof THREE.Face4)) {
        ...
        for (e = a.faceUvs.length; d < e; d++)
          a.faceUvs[d].length && ((i = a.faceUvs[d][b]), h[d].push(i, i));
      } else {
        f.push(d);
        d = 0;
  ...
  parseDDS: function (a, b) {
    ...
    for (
      ...
      for (var l = 0; l < d.mipmapCount; l++) {
        var n = (((Math.max(4, f) / 4) * Math.max(4, h)) / 4) * e,
          m = { data: new Uint8Array(a, g, n), width: f, height: h };
        d.mipmaps.push(m);
        g += n;
        f = Math.max(0.5 * f, 1);
        h = Math.max(0.5 * h, 1);
    ...
    for (
      ...
      for (var n = 0; n < e; n++) {
        var m = 0 > n - 1 ? 0 : n - 1,
          ...
          p = l + 1 > d - 1 ? d - 1 : l + 1,
          r = [],
          s = [0, 0, (g[4 * (n * d + l)] / 255) * b];
        r.push([-1, 0, (g[4 * (n * d + t)] / 255) * b]);
        r.push([-1, -1, (g[4 * (m * d + t)] / 255) * b]);
        r.push([0, -1, (g[4 * (m * d + l)] / 255) * b]);
        r.push([1, -1, (g[4 * (m * d + p)] / 255) * b]);
        r.push([1, 0, (g[4 * (n * d + p)] / 255) * b]);
        r.push([1, 1, (g[4 * (q * d + p)] / 255) * b]);
        r.push([0, 1, (g[4 * (q * d + l)] / 255) * b]);
        r.push([-1, 1, (g[4 * (q * d + t)] / 255) * b]);
        m = [];
        t = r.length;
        for (q = 0; q < t; q++) {
          var p = r[q],
            ...
            case "q":
              ...
              if ((h = f[f.length - 1])) {
                ...
                for (g = this.divisions; h <= g; h++) {
                  var v = h / g;
                  THREE.Shape.Utils.b2(v, n, q, i);
                  THREE.Shape.Utils.b2(v, m, t, l);
                }
              }
              break;
            case "b":
              if (
                ...
                for (g = this.divisions; h <= g; h++)
                  (v = h / g),
                    THREE.Shape.Utils.b3(v, n, q, p, i),
                    THREE.Shape.Utils.b3(v, m, t, r, l);
              }
          }
      }
      return { offset: s.ha * c, path: e };
    }
  }
};
...
(function (a) {
  ...
  a.Triangulate = function (a, d) {
    ...
    var f = [],
      ...
      j,
      l;
    if (0 < b(a)) for (j = 0; j < e; j++) h[j] = j;
    else for (j = 0; j < e; j++) h[j] = e - 1 - j;
    var n = 2 * e;
    for (j = e - 1; 2 < e; ) {
      if (0 >= n--) {
  ...
  for (e = this.actions.length; d < e; d++)
    switch (((f = this.actions[d]), (h = f.action), (f = f.args), h)) {
      ...
      case THREE.PathActions.QUADRATIC_CURVE_TO:
        ...
        m = f[1];
        0 < c.length
          ? ((h = c[c.length - 1]), (q = h.x), (t = h.y))
          : ((h = this.actions[d - 1].args),
            (q = h[h.length - 2]),
            (t = h[h.length - 1]));
        for (f = 1; f <= a; f++)
          (p = f / a),
            (h = THREE.Shape.Utils.b2(p, q, n, g)),
            (p = THREE.Shape.Utils.b2(p, t, m, i)),
            c.push(new THREE.Vector2(h, p));
        break;
      case THREE.PathActions.BEZIER_CURVE_TO:
        ...
        for (f = 1; f <= a; f++)
          (p = f / a),
            (h = THREE.Shape.Utils.b3(p, q, n, j, g)),
            (p = THREE.Shape.Utils.b3(p, t, m, l, i)),
            c.push(new THREE.Vector2(h, p));
        break;
...
THREE.Shape.Utils = {
  removeHoles: function (a, b) {
    ...
    for (i = 0; i < b.length; i++) {
      ...
      var p = [j[h], c[g], c[e]];
      n = THREE.FontUtils.Triangulate.area(p);
      var r = [j[h], j[f], c[g]];
  ...
  triangulateShape: function (a, b) {
    ...
    for (h = c.length; f < h; f++) {
      g = c[f];
      for (d = 0; 3 > d; d++)
        (i = g[d].x + ":" + g[d].y), (i = j[i]), void 0 !== i && (g[d] = i);
    }
    f = 0;
    ...
    for (var n = 0, m = this.hierarchy.length; n < m; n++) {
      ...
      for (var q = 0; 3 > q; q++) {
        ...
        if (g.time <= l) {
          if (j < l)
            if (this.loop) {
              h = this.data.hierarchy[n].keys[0];
              for (g = this.getNextKeyWith(c, n, 1); g.time < j; )
                (h = g), (g = this.getNextKeyWith(c, n, g.index + 1));
            } else {
              this.stop();
              return;
            }
          else {
            do (h = g), (g = this.getNextKeyWith(c, n, g.index + 1));
            while (g.time < j);
          }
          i.prevKey[c] = h;
          i.nextKey[c] = g;
        ...
        if ("pos" === c)
          if (
            ...
            if (
              ...
              (this.points[0] = this.getPrevKeyWith("pos", n, h.index - 1).pos),
                (this.points[1] = e),
                (this.points[2] = f),
      ...
      for (var a = 0, j = this.hierarchy.length; a < j; a++) {
        ...
        if (l.length) {
          for (l = 0; l < f.length; l++)
            (h = f[l]), (g = this.getPrevKeyWith(h, a, d)) && g.apply(h);
          this.data.hierarchy[a].node.updateMatrix();
          ...
          if (b && c) {
            if (c.time <= g) {
              if (i && this.loop) {
                ...
                for (var m = l.length - 1; c.time < h && c.index !== m; )
                  (b = c), (c = l[b.index + 1]);
              n.prevKey = b;
              n.nextKey = c;
            }
...
THREE.CubeGeometry = function (a, b, c, d, e, f) {
  function h(a, b, c, d, e, f, h, p) {
    ...
    if (("x" === a && "y" === b) || ("y" === a && "x" === b)) r = "z";
      ...
      (r = "y"), (v = g.depthSegments);
    else if (("z" === a && "y" === b) || ("y" === a && "z" === b))
      (r = "x"), (s = g.depthSegments);
    var H = s + 1,
      I = v + 1,
      F = e / s,
      A = f / v,
      ...
      for (f = 0; f < s; f++)
        (a = new THREE.Face4(
          ...
          g.faceVertexUvs[0].push([
            new THREE.Vector2(f / s, 1 - e / v),
            new THREE.Vector2(f / s, 1 - (e + 1) / v),
            new THREE.Vector2((f + 1) / s, 1 - (e + 1) / v),
            new THREE.Vector2((f + 1) / s, 1 - e / v)
          ]);
  }
  THREE.Geometry.call(this);
  var g = this;
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
  ...
  for (i = 0; i <= e; i++) {
    ...
    for (g = 0; g <= d; g++) {
      var p = g / d,
        r = new THREE.Vector3();
      r.x = t * Math.sin(2 * p * Math.PI);
      r.y = -q * c + h;
      r.z = t * Math.cos(2 * p * Math.PI);
      this.vertices.push(r);
      n.push(this.vertices.length - 1);
      m.push(new THREE.Vector2(p, 1 - q));
    }
    j.push(n);
    l.push(m);
  }
  ...
  for (g = 0; g < d; g++) {
    0 !== a
      ? ((n = this.vertices[j[0][g]].clone()),
        (m = this.vertices[j[0][g + 1]].clone()))
      : ((n = this.vertices[j[1][g]].clone()),
        (m = this.vertices[j[1][g + 1]].clone()));
    ...
    for (i = 0; i < e; i++) {
      var q = j[i][g],
        ...
        I = l[i + 1][g + 1].clone(),
        F = l[i][g + 1].clone();
      this.faces.push(new THREE.Face4(q, t, p, r, [s, v, z, G]));
      this.faceVertexUvs[0].push([C, H, I, F]);
    }
  }
  if (!1 === f && 0 < a) {
    ...
    for (g = 0; g < d; g++)
      (q = j[0][g]),
        ...
        (C = l[0][g].clone()),
        (H = l[0][g + 1].clone()),
        (I = new THREE.Vector2(H.u, 0)),
        this.faces.push(new THREE.Face3(q, t, p, [s, v, z])),
        this.faceVertexUvs[0].push([C, H, I]);
  }
  if (!1 === f && 0 < b) {
    this.vertices.push(new THREE.Vector3(0, -h, 0));
    for (g = 0; g < d; g++)
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    for (O = c.length; 0 <= --O; ) {
      ...
      for (var g = 0, h = q + 2 * l, g = 0; g < h; g++) {
        var i = oa * g,
          ...
          m = m + J,
          j = j + J;
        B.faces.push(new THREE.Face4(n, i, m, j, null, null, v));
        n = z.generateSideWallUV(B, a, p, b, n, i, m, j, r, s, t, w);
  ...
  function h(c, d, e, f) {
    ...
    c = f
      ? z.generateBottomUV(B, a, b, c, d, e)
      : z.generateTopUV(B, a, b, c, d, e);
  ...
  if ((t = !THREE.Shape.Utils.isClockWise(N))) {
    N = N.reverse();
    A = 0;
    for (K = m.length; A < K; A++)
      (F = m[A]), THREE.Shape.Utils.isClockWise(F) && (m[A] = F.reverse());
    t = !1;
  }
  var y = THREE.Shape.Utils.triangulateShape(N, m),
    t = N;
  A = 0;
  for (K = m.length; A < K; A++) (F = m[A]), (N = N.concat(F));
  var M,
    w,
    Z,
    L,
    ...
    qa = t.length;
  M = qa - 1;
  for (w = O + 1; O < qa; O++, M++, w++)
    M === qa && (M = 0), w === qa && (w = 0), (Va[O] = d(t[O], t[M], t[w]));
  var Fa = [],
    wa,
    D = Va.concat();
  A = 0;
  for (K = m.length; A < K; A++) {
    ...
    M = qa - 1;
    for (w = O + 1; O < qa; O++, M++, w++)
      M === qa && (M = 0), w === qa && (w = 0), (wa[O] = d(F[O], F[M], F[w]));
    Fa.push(wa);
    D = D.concat(wa);
  }
  for (M = 0; M < l; M++) {
    F = M / l;
    Z = i * (1 - F);
    w = j * Math.sin((F * Math.PI) / 2);
    O = 0;
    for (qa = t.length; O < qa; O++) (L = c(t[O], Va[O], w)), f(L.x, L.y, -Z);
    A = 0;
    for (K = m.length; A < K; A++) {
      F = m[A];
      wa = Fa[A];
      O = 0;
      for (qa = F.length; O < qa; O++) (L = c(F[O], wa[O], w)), f(L.x, L.y, -Z);
    }
  }
  w = j;
  for (O = 0; O < oa; O++)
    (L = n ? c(N[O], D[O], w) : N[O]),
      r
        ? (H.copy(G.normals[0]).multiplyScalar(L.x),
          C.copy(G.binormals[0]).multiplyScalar(L.y),
          I.copy(p[0]).add(H).add(C),
          f(I.x, I.y, I.z))
        : f(L.x, L.y, 0);
  for (F = 1; F <= q; F++)
    for (O = 0; O < oa; O++)
      (L = n ? c(N[O], D[O], w) : N[O]),
        r
          ? (H.copy(G.normals[F]).multiplyScalar(L.x),
            C.copy(G.binormals[F]).multiplyScalar(L.y),
            I.copy(p[F]).add(H).add(C),
            f(I.x, I.y, I.z))
          : f(L.x, L.y, (g / q) * F);
  for (M = l - 1; 0 <= M; M--) {
    F = M / l;
    ...
    w = j * Math.sin((F * Math.PI) / 2);
    O = 0;
    for (qa = t.length; O < qa; O++)
      (L = c(t[O], Va[O], w)), f(L.x, L.y, g + Z);
    A = 0;
    for (K = m.length; A < K; A++) {
      F = m[A];
      wa = Fa[A];
      O = 0;
      for (qa = F.length; O < qa; O++)
        (L = c(F[O], wa[O], w)),
          r ? f(L.x, L.y + p[q - 1].y, p[q - 1].x + Z) : f(L.x, L.y, g + Z);
    }
  }
  if (n) {
    i = 0 * oa;
    ...
    for (O = 0; O < Pa; O++)
      (g = y[O]), h(g[0] + oa * q, g[1] + oa * q, g[2] + oa * q, !1);
  }
  g = 0;
  e(t, g);
  g += t.length;
  A = 0;
  for (K = m.length; A < K; A++) (F = m[A]), e(F, g), (g += F.length);
};
THREE.ExtrudeGeometry.WorldUVGenerator = {
...
THREE.ShapeGeometry.prototype.addShape = function (a, b) {
  ...
  if (!THREE.Shape.Utils.isClockWise(i)) {
    ...
    for (f = j.length; e < f; e++)
      (h = j[e]), THREE.Shape.Utils.isClockWise(h) && (j[e] = h.reverse());
  }
  var l = THREE.Shape.Utils.triangulateShape(i, j);
  e = 0;
  for (f = j.length; e < f; e++) (h = j[e]), (i = i.concat(h));
  j = i.length;
  f = l.length;
  for (e = 0; e < j; e++)
  ...
  for (e = 0; e < f; e++)
    (j = l[e]),
      ...
      (h = j[1] + g),
      (j = j[2] + g),
      this.faces.push(new THREE.Face3(i, h, j, null, null, c)),
      this.faceVertexUvs[0].push(d.generateBottomUV(this, a, b, i, h, j));
};
THREE.LatheGeometry = function (a, b, c, d) {
  ...
  for (g = b; h < g; h++) {
    i = 0;
    for (n = a.length - 1; i < n; i++)
      (d = b = i + c * h),
        (l = b + c),
        (j = b + 1 + c),
        this.faces.push(new THREE.Face4(d, l, j, b + 1)),
        (j = h * f),
        (b = i * e),
        (d = j + f),
        (l = b + e),
  ...
  for (a = 0; a < d; a++) {
    ...
    for (b = 0; b <= c; b++) {
      var l = b + f,
        ...
        j = l + c + a,
        n = l + c + 1 + a;
      this.faces.push(new THREE.Face3(i, j, n, [e, e, e]));
      this.faceVertexUvs[0].push([h[i], h[j], h[n]]);
      i = l + a;
      j = l + c + 1 + a;
      n = l + 1 + a;
      this.faces.push(new THREE.Face3(i, j, n, [e, e, e]));
  ...
  for (i = 0; i <= c; i++) {
    ...
    for (g = 0; g <= b; g++) {
      var q = g / b,
        t = i / c,
        p = new THREE.Vector3();
      p.x = -a * Math.cos(d + q * e) * Math.sin(f + t * h);
      p.y = a * Math.cos(f + t * h);
      p.z = a * Math.sin(d + q * e) * Math.sin(f + t * h);
      this.vertices.push(p);
      n.push(this.vertices.length - 1);
      m.push(new THREE.Vector2(q, 1 - t));
    }
    j.push(n);
    l.push(m);
  }
  for (i = 0; i < this.heightSegments; i++)
    for (g = 0; g < this.widthSegments; g++) {
      ...
      Math.abs(this.vertices[b].y) === this.radius
        ? (this.faces.push(new THREE.Face3(b, d, e, [f, n, m])),
          this.faceVertexUvs[0].push([q, p, r]))
        : Math.abs(this.vertices[d].y) === this.radius
        ? (this.faces.push(new THREE.Face3(b, c, d, [f, h, n])),
          this.faceVertexUvs[0].push([q, t, p]))
        : (this.faces.push(new THREE.Face4(b, c, d, e, [f, h, n, m])),
          this.faceVertexUvs[0].push([q, t, p, r]));
    }
  this.computeCentroids();
  this.computeFaceNormals();
  this.boundingSphere = new THREE.Sphere(new THREE.Vector3(), a);
  ...
  for (b = 0; b < this.segments; b++)
    for (c = 0; c < this.radialSegments; c++)
      (e = this.closed ? (b + 1) % this.segments : b + 1),
        ...
        this.faces.push(new THREE.Face4(a, d, e, l)),
        this.faceVertexUvs[0].push([n, f, h, i]);
  this.computeCentroids();
  this.computeFaceNormals();
  this.computeVertexNormals();
};
...
THREE.TubeGeometry.FrenetFrames = function (a, b, c) {
  ...
  for (j = 1; j < b; j++)
    (f[j] = f[j - 1].clone()),
      (h[j] = h[j - 1].clone()),
      g.crossVectors(e[j - 1], e[j]),
      1e-4 < g.length() &&
        (g.normalize(),
        (d = Math.acos(THREE.Math.clamp(e[j - 1].dot(e[j]), -1, 1))),
        f[j].applyMatrix4(i.makeRotationAxis(g, d))),
      h[j].crossVectors(e[j], f[j]);
  if (c) {
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
  ...
  THREE.Geometry.call(this);
  for (var c = c || 1, d = d || 0, g = this, i = 0, j = a.length; i < j; i++)
    e(new THREE.Vector3(a[i][0], a[i][1], a[i][2]));
  for (var l = this.vertices, a = [], i = 0, j = b.length; i < j; i++) {
    var n = l[b[i][0]],
      m = l[b[i][1]],
      q = l[b[i][2]];
    a[i] = new THREE.Face3(n.index, m.index, q.index, [
      n.clone(),
      m.clone(),
      q.clone()
    ]);
  ...
  for (j = a.length; i < j; i++) {
    ...
    for (
      ...
      m[q] = [];
      for (
        var p = e(l.clone().lerp(t, q / b)),
          r = e(n.clone().lerp(t, q / b)),
          s = b - q,
          v = 0;
        v <= s;
        v++
      )
        m[q][v] = 0 == v && q == b ? p : e(p.clone().lerp(r, v / s));
    }
    for (q = 0; q < b; q++)
      for (v = 0; v < 2 * (b - q) - 1; v++)
        (l = Math.floor(v / 2)),
          0 == v % 2
            ? f(m[q][l + 1], m[q + 1][l], m[q][l])
            : f(m[q][l + 1], m[q + 1][l + 1], m[q + 1][l]);
  }
  i = 0;
  for (j = this.faceVertexUvs[0].length; i < j; i++)
    (d = this.faceVertexUvs[0][i]),
      ...
      (b = d[1].x),
      (l = d[2].x),
      (n = Math.max(a, Math.max(b, l))),
      (m = Math.min(a, Math.min(b, l))),
      0.9 < n &&
        0.1 > m &&
        (0.2 > a && (d[0].x += 1),
        0.2 > b && (d[1].x += 1),
  ...
  for (g = 0; g < c; g++)
    for (i = 0; i < b; i++)
      (a = g * n + i),
        ...
        (l = (g + 1) * n + i),
        (j = (g + 1) * n + i + 1),
        (m = new THREE.Vector2(i / b, g / c)),
        (q = new THREE.Vector2((i + 1) / b, g / c)),
        (t = new THREE.Vector2(i / b, (g + 1) / c)),
        (p = new THREE.Vector2((i + 1) / b, (g + 1) / c)),
        d
          ? (f.push(new THREE.Face3(a, e, l)),
            f.push(new THREE.Face3(e, j, l)),
            h.push([m, q, t]),
            h.push([q, p, t]))
          : (f.push(new THREE.Face4(a, e, j, l)), h.push([m, q, p, t]));
  this.computeCentroids();
  this.computeFaceNormals();
  this.computeVertexNormals();
};
...
THREE.ConvexGeometry = function (a) {
  ...
  for (
    ...
    var e = d,
      f = a[e].clone(),
      h = f.length();
    f.x += h * 2e-6 * (Math.random() - 0.5);
    f.y += h * 2e-6 * (Math.random() - 0.5);
    f.z += h * 2e-6 * (Math.random() - 0.5);
    for (var h = [], g = 0; g < c.length; ) {
      var i = c[g],
        j = f,
        l = a[i[0]],
        n;
    ...
    for (m = 0; m < h.length; m++) c.push([h[m][0], h[m][1], e]);
  }
  e = 0;
  f = Array(a.length);
  for (d = 0; d < c.length; d++) {
    h = c[d];
    for (g = 0; 3 > g; g++)
      void 0 === f[h[g]] && ((f[h[g]] = e++), this.vertices.push(a[h[g]])),
        (h[g] = f[h[g]]);
  }
  for (d = 0; d < c.length; d++)
...
THREE.SpotLightHelper.prototype.update = (function () {
  ...
  return function () {
    ...
    this.scale.set(c, c, b);
    this.light.updateMatrixWorld(!0);
    this.position.getPositionFromMatrix(this.light.matrixWorld);
    this.light.target.updateMatrixWorld(!0);
    a.getPositionFromMatrix(this.light.target.matrixWorld);
    this.lookAt(a);
    this.material.color
      .copy(this.light.color)
      .multiplyScalar(this.light.intensity);
...
THREE.VertexNormalsHelper.prototype.update = (function () {
  ...
  return function () {
    ...
    for (
      ...
      for (var j = e[g], l = 0, n = j.vertexNormals.length; l < n; l++) {
        var m = j.vertexNormals[l];
...
THREE.VertexTangentsHelper.prototype.update = (function () {
  ...
  return function () {
    ...
    for (
      ...
      for (var j = e[g], l = 0, n = j.vertexTangents.length; l < n; l++) {
        var m = j.vertexTangents[l];
        c[h].copy(d[j[b[l]]]).applyMatrix4(f);
        a.copy(m).transformDirection(f).multiplyScalar(this.size);
        a.add(c[h]);
        h += 1;
        c[h].copy(a);
        h += 1;
...
THREE.WireframeHelper = function (a) {
  for (
    ...
    for (
      var l = g[i], n = l instanceof THREE.Face4 ? 4 : 3, m = 0;
      m < n;
      m++
    ) {
      b[0] = l[e[m]];
      ...
      var q = b.toString();
      void 0 === c[q] &&
        (f.vertices.push(h[b[0]]), f.vertices.push(h[b[1]]), (c[q] = !0));
    }
  THREE.Line.call(
    this,
    f,
...
THREE.LensFlarePlugin = function () {
  ...
  this.init = function (t) {
    ...
    0 >= b.getParameter(b.MAX_VERTEX_TEXTURE_IMAGE_UNITS)
      ? ((l = !1), (n = a(THREE.ShaderFlares.lensFlare, d)))
      : ((l = !0), (n = a(THREE.ShaderFlares.lensFlareVertexTexture, d)));
    m = {};
    q = {};
    m.vertex = b.getAttribLocation(n, "position");
    m.uv = b.getAttribLocation(n, "uv");
    q.renderType = b.getUniformLocation(n, "renderType");
    q.map = b.getUniformLocation(n, "map");
    q.occlusionMap = b.getUniformLocation(n, "occlusionMap");
    q.opacity = b.getUniformLocation(n, "opacity");
    q.color = b.getUniformLocation(n, "color");
    q.scale = b.getUniformLocation(n, "scale");
    q.rotation = b.getUniformLocation(n, "rotation");
    q.screenPosition = b.getUniformLocation(n, "screenPosition");
  };
    ...
    if (v) {
      ...
      for (J = 0; J < v; J++)
        if (
          ...
          b.enable(b.BLEND);
          N = 0;
          for (y = M.lensFlares.length; N < y; N++)
            (w = M.lensFlares[N]),
              0.001 < w.opacity &&
                0.001 < w.scale &&
                ((A.x = w.x),
                ...
                b.uniform3f(B.screenPosition, A.x, A.y, A.z),
                b.uniform2f(B.scale, F.x, F.y),
                b.uniform1f(B.rotation, w.rotation),
                b.uniform1f(B.opacity, w.opacity),
                b.uniform3f(B.color, w.color.r, w.color.g, w.color.b),
                c.setBlending(
                  w.blending,
                  w.blendEquation,
                  w.blendSrc,
...
THREE.ShadowMapPlugin = function () {
  ...
  this.update = function (n, m) {
    ...
    b.setDepthTest(!0);
    q = 0;
    for (t = n.__lights.length; q < t; q++)
      if (((p = n.__lights[q]), p.castShadow))
        if (p instanceof THREE.DirectionalLight && p.shadowCascade)
          for (s = 0; s < p.shadowCascadeCount; s++) {
            var I;
            if (p.shadowCascadeArray[s]) I = p.shadowCascadeArray[s];
            else {
              C = p;
              z = s;
              ...
              I.onlyShadow = !0;
              I.castShadow = !0;
              I.shadowCameraNear = C.shadowCameraNear;
              I.shadowCameraFar = C.shadowCameraFar;
              I.shadowCameraLeft = C.shadowCameraLeft;
              I.shadowCameraRight = C.shadowCameraRight;
              I.shadowCameraBottom = C.shadowCameraBottom;
              I.shadowCameraTop = C.shadowCameraTop;
              I.shadowCameraVisible = C.shadowCameraVisible;
              I.shadowDarkness = C.shadowDarkness;
              I.shadowBias = C.shadowCascadeBias[z];
              I.shadowMapWidth = C.shadowCascadeWidth[z];
              I.shadowMapHeight = C.shadowCascadeHeight[z];
              I.pointsWorld = [];
              I.pointsFrustum = [];
              G = I.pointsWorld;
              v = I.pointsFrustum;
              for (var F = 0; 8 > F; F++)
                (G[F] = new THREE.Vector3()), (v[F] = new THREE.Vector3());
              G = C.shadowCascadeNearZ[z];
              C = C.shadowCascadeFarZ[z];
              v[0].set(-1, -1, G);
              v[1].set(1, -1, G);
              v[2].set(-1, 1, G);
              v[3].set(1, 1, G);
              ...
              v.add(I.target);
              m.add(v);
              p.shadowCascadeArray[s] = I;
              console.log("Created virtualLight", I);
            }
            z = p;
            G = s;
            C = z.shadowCascadeArray[G];
            C.position.copy(z.position);
            C.target.position.copy(z.target.position);
            C.lookAt(C.target);
            C.shadowCameraVisible = z.shadowCameraVisible;
            C.shadowDarkness = z.shadowDarkness;
            C.shadowBias = z.shadowCascadeBias[G];
            v = z.shadowCascadeNearZ[G];
            z = z.shadowCascadeFarZ[G];
            C = C.pointsFrustum;
            C[0].z = v;
            C[1].z = v;
            C[2].z = v;
    ...
    q = 0;
    for (t = H.length; q < t; q++) {
      p = H[q];
      p.shadowMap ||
        ((s = THREE.LinearFilter),
      ...
      if (p.isVirtual && I.originalCamera == m) {
        s = m;
        r = p.shadowCamera;
        v = p.pointsFrustum;
        C = p.pointsWorld;
        ...
        for (z = 0; 8 > z; z++)
          (G = C[z]),
            G.copy(v[z]),
            THREE.ShadowMapPlugin.__projector.unprojectVector(G, s),
            G.applyMatrix4(r.matrixWorldInverse),
            G.x < i.x && (i.x = G.x),
            G.x > j.x && (j.x = G.x),
            G.y < i.y && (i.y = G.y),
            G.y > j.y && (j.y = G.y),
          ...
          z.render &&
            ...
            (F =
              v.material instanceof THREE.MeshFaceMaterial
                ...
                : v.material),
            (G = 0 < v.geometry.morphTargets.length && F.morphTargets),
            (F = v instanceof THREE.SkinnedMesh && F.skinning),
            (G = v.customDepthMaterial
            ...
            z instanceof THREE.BufferGeometry
              ? b.renderBufferDirect(s, n.__lights, null, G, z, v)
              : b.renderBuffer(s, n.__lights, null, G, z, v));
      C = n.__webglObjectsImmediate;
      p = 0;
      for (r = C.length; p < r; p++)
        (z = C[p]),
          (v = z.object),
          v.visible &&
            ...
            b.renderImmediateObject(s, n.__lights, null, c, v));
    }
    q = b.getClearColor();
    t = b.getClearAlpha();
...
THREE.SpritePlugin = function () {
  ...
  this.init = function (a) {
    ...
    var a = THREE.ShaderSprite.sprite,
      ...
      p = "precision " + d + " float;\n";
    b.shaderSource(q, p + a.fragmentShader);
    b.shaderSource(t, p + a.vertexShader);
    b.compileShader(q);
    b.compileShader(t);
    b.attachShader(m, q);
    b.attachShader(m, t);
  ...
  this.render = function (d, e, f, t) {
    ...
    if (r) {
      ...
      var C = (s = 0),
        H = d.fog;
      H
        ? (b.uniform3f(v.fogColor, H.color.r, H.color.g, H.color.b),
          H instanceof THREE.Fog
            ? (b.uniform1f(v.fogNear, H.near),
              b.uniform1f(v.fogFar, H.far),
              b.uniform1i(v.fogType, 1),
              (C = s = 1))
            : H instanceof THREE.FogExp2 &&
              (b.uniform1f(v.fogDensity, H.density),
              b.uniform1i(v.fogType, 2),
              (C = s = 2)))
        : (b.uniform1i(v.fogType, 0), (C = s = 0));
      for (var I, F, A = [], H = 0; H < r; H++)
        (I = p[H]),
          (F = I.material),
          I.visible &&
            0 !== F.opacity &&
            (F.useScreenCoordinates
              ? (I.z = -I.position.z)
              : (I._modelViewMatrix.multiplyMatrices(
                  e.matrixWorldInverse,
                  I.matrixWorld
                ),
                (I.z = -I._modelViewMatrix.elements[14])));
      p.sort(a);
      for (H = 0; H < r; H++)
        (I = p[H]),
          (F = I.material),
          I.visible &&
            ...
            F.map.image &&
            F.map.image.width &&
            (b.uniform1f(v.alphaTest, F.alphaTest),
            !0 === F.useScreenCoordinates
              ? (b.uniform1i(v.useScreenCoordinates, 1),
                b.uniform3f(
                  v.screenPosition,
                  (I.position.x * c.devicePixelRatio - f) / f,
                  (G - I.position.y * c.devicePixelRatio) / G,
                  Math.max(0, Math.min(1, I.position.z))
                ),
                (A[0] = c.devicePixelRatio),
                (A[1] = c.devicePixelRatio))
              : (b.uniform1i(v.useScreenCoordinates, 0),
                b.uniform1i(v.sizeAttenuation, F.sizeAttenuation ? 1 : 0),
                b.uniformMatrix4fv(
                  v.modelViewMatrix,
                  !1,
                  I._modelViewMatrix.elements
                ),
                (A[0] = 1),
                (A[1] = 1)),
            (e = d.fog && F.fog ? C : 0),
            s !== e && (b.uniform1i(v.fogType, e), (s = e)),
            (e = 1 / (F.scaleByViewport ? t : 1)),
            (A[0] *= e * z * I.scale.x),
            (A[1] *= e * I.scale.y),
            b.uniform2f(v.uvScale, F.uvScale.x, F.uvScale.y),
            b.uniform2f(v.uvOffset, F.uvOffset.x, F.uvOffset.y),
            b.uniform2f(v.alignment, F.alignment.x, F.alignment.y),
            b.uniform1f(v.opacity, F.opacity),
            b.uniform3f(v.color, F.color.r, F.color.g, F.color.b),
            b.uniform1f(v.rotation, I.rotation),
            b.uniform2fv(v.scale, A),
            c.setBlending(F.blending, F.blendEquation, F.blendSrc, F.blendDst),
            c.setDepthTest(F.depthTest),
            c.setDepthWrite(F.depthWrite),
            c.setTexture(F.map, 0),
            b.drawElements(b.TRIANGLES, 6, b.UNSIGNED_SHORT, 0));
      b.enable(b.CULL_FACE);
    }
  };
...
THREE.DepthPassPlugin = function () {
  ...
  this.update = function (i, j) {
    ...
    g.multiplyMatrices(j.projectionMatrix, j.matrixWorldInverse);
    h.setFromMatrix(g);
    ...
    for (n = p.length; l < n; l++)
      if (
        ...
        (r =
          ...
          (q = 0 < t.geometry.morphTargets.length && r.morphTargets),
          (r = t instanceof THREE.SkinnedMesh && r.skinning),
          (q = t.customDepthMaterial
          ...
          m instanceof THREE.BufferGeometry
            ? b.renderBufferDirect(j, i.__lights, null, q, m, t)
            : b.renderBuffer(j, i.__lights, null, q, m, t);
    ...
    for (n = p.length; l < n; l++)
      (m = p[l]),
        ...
        t.visible &&
          ...
          b.renderImmediateObject(j, i.__lights, null, c, t));
    l = b.getClearColor();
    n = b.getClearAlpha();
    a.clearColor(l.r, l.g, l.b, n);
    a.enable(a.BLEND);
  };
};
THREE.ShaderFlares = {
